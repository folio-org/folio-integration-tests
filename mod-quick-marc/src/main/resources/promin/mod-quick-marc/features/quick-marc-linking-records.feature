Feature: linking-records tests
  ...
  Background:
    ...
    * def snapshotId = '7dbf5dcf-f46c-42cd-924b-04d99cd410b9'
    ...
    And request read('classpath:promin/mod-quick-marc/features/setup/samples/setup-records/instance.json')
    When method POST
    Then status 201

    Given path 'source-storage/records'
    And request read('classpath:promin/mod-quick-marc/features/setup/samples/setup-records/marc-bib.json')
    When method POST
    Then status 201
