Feature: Parallel Checkout Tests
  Background:
    ...
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostMaterialType') { extMaterialTypeId: #(materialTypeId) }

     # settings
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostSettings')
    ...
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: '#(fourthUserGroupId)' }
    ...
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLoanPolicyWithLimit') { extLoanPolicyId: #(loanPolicyId) }
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLoanPolicyWithLimit') { extLoanPolicyId: #(loanPolicyMaterialId) }
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLostPolicy') { extLostItemFeePolicyId: #(lostItemFeePolicyId) }
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostOverduePolicy') { extOverdueFinePoliciesId: #(overdueFinePoliciesId) }
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostPatronPolicy') { extPatronPolicyId: #(patronPolicyId) }
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequestPolicy') { extRequestPolicyId: #(requestPolicyId) }
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@UpdateRules') extFallbackPolicy, extMaterialTypePolicy
    ...
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint')
    ...
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode), extMaterialTypeId: #(materialTypeId)}
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId1), extItemBarcode: #(extItemBarcode1), extMaterialTypeId: #(materialTypeId)}

    # post a group and a user
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: #(groupId) }
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId), extUserBarcode: #(extUserBarcode), extGroupId: #(groupId) }
