Feature: Loans tests
  ...
  Background:
    ...
    * def parseObjectToDate = read('classpath:vega/mod-circulation/eureka-features/util/parse-object-to-date-function.js')
  ...
  Scenario: When patron and item id's entered at checkout, post a new loan using the circulation rule matched
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLocation')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint')

    # post an item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode), extMaterialTypeId: #(materialTypeId)}

    # post a group and a user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: #(groupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId), extUserBarcode: #(extUserBarcode), extGroupId: #(groupId) }

    # checkOut the item for the user
    * def checkOutResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode) }
  ...
  Scenario: Get checkIns records, define current item checkIn record and its status
    ...
    * def extItemBarcode = 'FAT-unknownIBC'
    ...
    # location and service point setup
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLocation') { extInstitutionId: #(extInstitutionId), extCampusId: #(extCampusId), extLibraryId: #(extLibraryId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint')

    # post an item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance') { extInstanceTypeId: #(extInstanceTypeId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode), extMaterialTypeId: #(materialTypeId)}

    # post a group and a user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: #(groupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserBarcode: #(extUserBarcode), extGroupId: #(groupId) }

    # checkOut the item for the user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode) }

    # checkIn the item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@CheckInItem') { itemBarcode: #(extItemBarcode) }
  ...
  Scenario: When get loans for a patron is called, return a paged collection of loans for that patron with all data as specified in the circulation/loans API
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemBarcode: #(extItemBarcode1), extMaterialTypeId: #(materialTypeId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemBarcode: #(extItemBarcode2), extMaterialTypeId: #(materialTypeId) }

    # post a group and a user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: #(groupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserBarcode: #(extUserBarcode), extUserId: #(extUserId) }

    # checkOut the first item
    * def checkOutResponse1 = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode1) }
    # checkOut the second item
    * def checkOutResponse2 = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode2) }
  ...
  Scenario: When an existing loan is declared lost, update declaredLostDate, item status to declared lost and bill lost item fees per the Lost Item Fee Policy
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint')
    ...
    # post an owner
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostOwner')
    ...
    * def declaredLostDateTime = call read('classpath:vega/mod-circulation/eureka-features/util/get-time-now-function.js')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@DeclareItemLost') { loanId: #(loanId), declaredLostDateTime: #(declaredLostDateTime) }
  ...
  Scenario: Post item, two patrons, check out item and post a recall request, assert expectedDueDateBeforeRequest and dueDate
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLocation') { extInstitutionId: #(extInstitutionId), extCampusId: #(extCampusId), extLibraryId: #(extLibraryId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings') { extInstanceTypeId: #(extInstanceTypeId), extHoldingsRecordId: #(extHoldingsRecordId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemBarcode: '333333', extMaterialTypeId: #(materialTypeId), extItemId: #(extItemId), extHoldingsRecordId: #(extHoldingsRecordId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: #(groupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId), extUserBarcode: '44441' }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId2), extUserBarcode: '44442' }

    # checkOut an item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: '44441', extCheckOutItemBarcode: '333333' }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { itemId: #(extItemId), requesterId: #(extUserId2), extInstanceId: #(extInstanceId), extHoldingsRecordId: #(extHoldingsRecordId) }
  ...
  Scenario: When an loaned item is checked in at a service point that serves its location and no request exists, change the item status to Available
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(itemId), extItemBarcode: #(extItemBarcode)}
    ...
    * def checkInResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@CheckInItem') { itemBarcode: #(extItemBarcode) }
  ...
  Scenario: When an requested loaned item is checked in at a service point designated as the pickup location of the request, change the item status to awaiting-pickup
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLocation')
    ...
    # post an item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance') { extInstanceId: #(extInstanceId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings') { extHoldingsRecordId: #(extHoldingsRecordId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(itemId), extItemBarcode: #(extItemBarcode), extHoldingsRecordId: #(extHoldingsRecordId) }

    # post an user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: #(groupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserBarcode: #(extUserBarcode1), extUserId: #(extUserId1) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserBarcode: #(extUserBarcode2), extUserId: #(extUserId2) }

    # checkOut the item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode1), extCheckOutItemBarcode: #(extItemBarcode) }

    # post a request for the checked-out-item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId), itemId: #(itemId), requesterId: #(extUserId2), extInstanceId: #(extInstanceId), extHoldingsRecordId: #(extHoldingsRecordId) }
  ...
  Scenario:  When a loaned item is checked in at a service point that does not serve its location and no request exists, change the item status to In-transit and destination to primary service point for its location
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLocation') { extLocationId: #(extLocationId1),  extInstitutionId: #(extInstitutionId1), extCampusId: #(extCampusId1), extLibraryId: #(extLibraryId1), extServicePointId: #(extServicePointId1) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { servicePointId: #(extServicePointId1) }

    # second location and service point setup
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLocation') { extLocationId: #(extLocationId2), extInstitutionId: #(extInstitutionId2), extCampusId: #(extCampusId2), extLibraryId: #(extLibraryId2), extServicePointId: #(extServicePointId2) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { servicePointId: #(extServicePointId2) }

    # post an item which is located in the first location
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings') { extLocationId: #(extLocationId1) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(itemId), extItemBarcode: #(extItemBarcode) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserBarcode: #(extUserBarcode), extUserId: #(extUserId) }
    ...
    # check-out the item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode), extServicePointId: #(extServicePointId1) }
    ...
    * def checkInResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@CheckInItem') { itemBarcode: #(extItemBarcode), extServicePointId: #(extServicePointId2) }
    * def item = checkInResponse.response.item
    And match item.id == itemId
  ...
  Scenario: When an item has the status intellectual item, do not allow checkout
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemBarcode: #(extItemBarcode), extStatusName: #(extStatusName) }

    # post a user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: #(groupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserBarcode: #(extUserBarcode) }
  ...
  Scenario: When an item that had the status of restricted that was checked out is checked in, set the item status to Available
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserBarcode: #(extUserBarcode) }
    ...
    # checkOut the item for the user
    * def checkOutResult = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode) }
    * def loanId = checkOutResult.response.id

    # checkIn the item and verify that loan.status is 'Closed' and item.status is 'Available'
    * def postCheckInResult = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@CheckInItem') { itemBarcode: #(extItemBarcode) }
  ...
  Scenario: When an item has the status of in process allow checkout
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * def postItemResult = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(itemId), extItemBarcode: #(extItemBarcode) }
...
#    * configure headers = headersUser
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLocation') { extLocationId: #(extLocationId3), extInstitutionId: #(extInstitutionId3), extCampusId: #(extCampusId3), extLibraryId: #(extLibraryId3), extServicePointId: #(extServicePointId3) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { servicePointId: #(extServicePointId3) }

    # post an item which is located in the first location
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance') { extInstanceId: #(extInstanceId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings') { extLocationId: #(extLocationId1), extHoldingsRecordId: #(extHoldingsRecordId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(itemId), extItemBarcode: #(extItemBarcode), extHoldingsRecordId: #(extHoldingsRecordId) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode1), extCheckOutItemBarcode: #(extItemBarcode), extServicePointId: #(extServicePointId1) }

    # second user posts a request for the checked-out-item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId), itemId: #(itemId), requesterId: #(extUserId2), extServicePointId: #(extServicePointId2), extInstanceId: #(extInstanceId), extHoldingsRecordId: #(extHoldingsRecordId) }

    # check-in the item from third service point and verify that item status is changed to 'In transit'
    * def checkInResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@CheckInItem') { itemBarcode: #(extItemBarcode), extServicePointId: #(extServicePointId3) }
    * def item = checkInResponse.response.item
    And match item.id == itemId
    And match item.status.name == 'In transit'
  ...
  Scenario: When an item has the status of restricted, allow checkout with override
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLocation')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * def postItemResult = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemBarcode: #(extItemBarcode), extMaterialTypeId: #(materialTypeId) }
    * def itemId = postItemResult.response.id
  ...
  Scenario: When an item that had the status of in process that was checked out is checked in, set the item status to Available
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * def postItemResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemBarcode: #(extItemBarcode) }
  ...
  Scenario: When an item has the status of on order allow checkout
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * def postItemResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemBarcode: #(extItemBarcode), extStatusName: #(extStatusName) }
    * def itemId = postItemResponse.response.id
  ...
  Scenario: When an item that had the status of On order that was checked out is checked in, item status should be changed to Available
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * def postItemResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(itemId), extItemBarcode: #(extItemBarcode), extStatusName: #(extStatusName) }
    * def itemId = postItemResponse.response.id
    And match postItemResponse.response.status.name == extStatusName
    ...
    * def postCheckInResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@CheckInItem') { itemBarcode: #(extItemBarcode) }
  ...
  Scenario: When an overdue item is returned, an overdue fine is billed per the Overdue Fine Policy
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostOwner')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostManualCharge')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostPaymentMethod')
    ...
    * def loanId = checkOutResponse.response.id
    ...
    # checkIn the item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@CheckInItem') { itemBarcode: #(extItemBarcode), extCheckInDate: #(extCheckInDate) }
    ...
    * def postPayResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostPay') { amount: #(overdueFineAmount) }
  ...
  Scenario: When an existing loan is claimed returned, update claimedReturnedDate, suspend any lost item fees billed and refund any lost item fees paid
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserBarcode: #(extUserBarcode) }
    ...
    # post owner, manual charge and payment method
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostOwner')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostManualCharge') { extManualChargeId: #(extManualChargeId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostPaymentMethod')
    ...
    * def postPayResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostPay') { accountId: #(lostItemFineAccountId), amount: #(lostItemFineAmount) }
    * def feefineactionInResponse = postPayResponse.response.feefineactions[0]
    And match feefineactionInResponse.typeAction == 'Paid fully'
    ...
    * def claimItemReturnedDate = call read('classpath:vega/mod-circulation/eureka-features/util/get-time-now-function.js')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostClaimItemReturned')

    # update accounts
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PutAccount') { accountId: #(lostItemFineAccountId), barcode: #(extItemBarcode), amount: #(lostItemFineAmount), feeFineId: #(lostItemFeeFineId), feeFineType: #(lostItemFeeFineType), holdingsRecordId: #(holdingId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PutAccount') { accountId: #(lostItemProcessingFineAccountId), barcode: #(extItemBarcode), amount: #(lostItemProcessingFineAmount), feeFineId: #(lostItemProcessingFeeFineId), feeFineType: #(lostItemProcessingFeeFineType), holdingsRecordId: #(holdingId) }
    ...
    * def creditedFeeInResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRefundFee') { accountId: #(lostItemFineAccountId), amount: #(lostItemFineAmount), balance: 0, typeAction: #(typeAction1) }
    ...
    * def refundedFeeInResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRefundFee') { accountId: #(lostItemFineAccountId), amount: #(lostItemFineAmount), balance: #(lostItemFineAmount), typeAction: #(typeAction2) }
  ...
  Scenario: When an existing loan is aged to lost update agedToLostDate, item status to Aged to lost
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemBarcode: #(extItemBarcode) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserBarcode: #(extUserBarcode) }
    ...
    # checkOut the item
    * def checkOutResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode), extLoanDate: #(extLoanDate) }
    ...
    * def updateRequest = read('classpath:vega/mod-circulation/eureka-features/samples/change-age-to-lost-processor-delay-time.json')
    ...
    * def revertRequest = read('classpath:vega/mod-circulation/eureka-features/samples/change-age-to-lost-processor-delay-time.json')
  ...
  Scenario: When an existing loan is checked in, update checkInServicePointId, returnDate
    ...
    * def extServicePointId = call uuid1
    ...
    # location and service point setup
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLocation')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { servicePointId: #(extServicePointId) }
    ...
    * def extCheckInDate = call read('classpath:vega/mod-circulation/eureka-features/util/get-time-now-function.js')
    * def checkInResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@CheckInItem') { itemBarcode: #(extItemBarcode), extServicePointId: #(extServicePointId), extCheckInDate: #(extCheckInDate) }
  ...
  Scenario: When an existing loan is marked for renewal, update the loan record including renewal count and renewal date
    ...
    * def extLoanId = checkOutResponse.response.id
    ...
    # renew the loan
    * def renewalRequest = read('classpath:vega/mod-circulation/eureka-features/samples/loan-renewal-request-entity-loan.json')
  ...
  Scenario: When an existing loan is aged to lost update agedToLostDate and aged to lost policy specifies delayed billing, update lostItemHasBeenBilled, dateLostItemShouldBeBilled
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint')
    ...
    # post a group and a user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: #(groupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId), extUserBarcode: #(extUserBarcode) }
  ...
  Scenario: When patron has exceeded their Patron Group Limit for 'Maximum number of items charged out', patron is not allowed to borrow items per Conditions settings
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemBarcode: #(extItemBarcode1) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PutPatronBlockConditionById') { pbcId: #(patronBlockCondition.id), pbcMessage: #(patronBlockCondition.blockMessage), blockBorrowing: #(true), blockRenewals: #(false), blockRequests: #(false), pbcName: #(patronBlockCondition.name) }

    # set patron block limits
    * def limitId = call uuid1
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostPatronBlocksLimitsByConditionId') { id: #(limitId), extGroupId: #(groupId), pbcId: #(patronBlockCondition.id), extValue: #(1) }

    # checkOut the items
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode1) }
    ...
    * def extItemId = call uuid1
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode2) }

    * def loanDate = call read('classpath:vega/mod-circulation/eureka-features/util/get-time-now-function.js')
    * def checkOutByBarcodeEntityRequest = read('samples/check-out-by-barcode-entity-request.json')
    * checkOutByBarcodeEntityRequest.userBarcode = extUserBarcode
  ...
  Scenario: When an item has the status of Lost and paid, allow checkout with override
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: #(groupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserBarcode: #(extUserBarcode1) }

    # checkout the item by the first user
    * def checkOutResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode1), extCheckOutItemBarcode: #(extItemBarcode) }
    * def extLoanId = checkOutResponse.response.id

    # declare the item as lost
    * def extDeclaredLostDateTime = call read('classpath:vega/mod-circulation/eureka-features/util/get-time-now-function.js')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@DeclareItemLost') { loanId: #(extLoanId), declaredLostDateTime:#(extDeclaredLostDateTime) }
    ...
    * def postPayResponse1 = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostPay') { accountId: #(lostItemFineAccountId), amount: #(lostItemFineAmount) }
    * def feefineactionInResponse1 = postPayResponse1.response.feefineactions[0]
    ...
    # pay the lost item fine and verify that the lost item fine is paid fully
    * def postPayResponse2 = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostPay') { accountId: #(lostItemProcessingFineAccountId), amount: #(lostItemProcessingFineAmount) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserBarcode: #(extUserBarcode2) }

    # checkout the item which is on the lost and paid state for the second user
    * def checkOutResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode2), extCheckOutItemBarcode: #(extItemBarcode) }
  ...
  Scenario: When patron has exceeded their Patron Group Limit 'Maximum number of overdue items', patron is not allowed to borrow items per Conditions settings
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemBarcode: #(extItemBarcode1) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemBarcode: #(extItemBarcode2) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostPatronBlocksLimitsByConditionId') { id: #(limitId), extGroupId: #(groupId), pbcId: #(patronBlockCondition.id), extValue: #(1) }
    ...
    # checkOut the items
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode1), extLoanDate: #(extLoanDate) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode2), extLoanDate: #(extLoanDate) }
    ...
    * def extItemId = call uuid1
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode3) }
  ...
  Scenario: When patron has exceeded their Patron Group Limit for 'Maximum outstanding fee/fine balance', patron is not allowed to borrow items per Conditions settings
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PutPatronBlockConditionById') { pbcId: #(patronBlockCondition.id), pbcMessage: #(patronBlockCondition.blockMessage), blockBorrowing: #(true), blockRenewals: #(false), blockRequests: #(false), pbcName: #(patronBlockCondition.name) }
    ...
    # set patron block limits
    * def limitId = call uuid1
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostPatronBlocksLimitsByConditionId') { id: #(limitId), extGroupId: #(groupId), pbcId: #(patronBlockCondition.id), extValue: #(7.50) }

    # checkOut the item
    * def checkOutResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode1) }
    * def extLoanId = checkOutResponse.response.id

    # declare item lost and verify that the user has got lost item fee/fine
    * def extLostDate = call read('classpath:vega/mod-circulation/eureka-features/util/get-time-now-function.js')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@DeclareItemLost') { loanId: #(extLoanId), declaredLostDateTime: #(extLostDate), servicePointId: #(servicePointId) }
  ...
  Scenario: When patron has exceeded their Patron Group Limit for 'Maximum number of overdue recalls', patron is not allowed to borrow items per Conditions settings
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance') { extInstanceId: #(extInstanceId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId1), extItemBarcode: #(extItemBarcode1) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId2), extItemBarcode: #(extItemBarcode2) }

    # post a group and users
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: #(groupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId1), extUserBarcode: #(extUserBarcode1) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId2), extUserBarcode: #(extUserBarcode2) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostPatronBlocksLimitsByConditionId') { id: #(limitId), extGroupId: #(groupId), pbcId: #(patronBlockCondition.id), extValue: #(1) }
    ...
    # checkOut the items
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode1), extCheckOutItemBarcode: #(extItemBarcode1) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode1), extCheckOutItemBarcode: #(extItemBarcode2) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId1), itemId: #(extItemId1), requesterId: #(extUserId2), extRequestType: #(extRequestType), extInstanceId: #(extInstanceId), extHoldingsRecordId: #(holdingId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId2), itemId: #(extItemId2), requesterId: #(extUserId2), extRequestType: #(extRequestType), extInstanceId: #(extInstanceId), extHoldingsRecordId: #(holdingId) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') {  extItemId: #(extItemId3), extItemBarcode: #(extItemBarcode3) }
  ...
  Scenario: When patron has exceeded their Patron Group Limit for 'Recall overdue by maximum number of days', patron is not allowed to borrow items per Conditions settings
    ...
    * def extUserId2 = call uuid1
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: #(groupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId1), extUserBarcode: #(extUserBarcode1), extGroupId: #(groupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId2), extUserBarcode: #(extUserBarcode2), extGroupId: #(groupId) }
    ...
    * def extRequestId = call uuid1
    * def requestEntityRequest = read('classpath:vega/mod-circulation/eureka-features/samples/request/request-entity-request.json')
  ...
  Scenario: When patron has exceeded their Patron Group Limit for 'Maximum number of lost items', patron is not allowed to renew items per Conditions settings
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PutPatronBlockConditionById') { pbcId: #(patronBlockCondition.id), pbcMessage: #(patronBlockCondition.blockMessage), blockBorrowing: #(false), blockRenewals: #(true), blockRequests: #(false), pbcName: #(patronBlockCondition.name) }
    ...
    * def declaredLostDateTime = call read('classpath:vega/mod-circulation/eureka-features/util/get-time-now-function.js')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@DeclareItemLost') { loanId: #(loanId1), declaredLostDateTime:#(declaredLostDateTime) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@DeclareItemLost') { loanId: #(loanId2), declaredLostDateTime:#(declaredLostDateTime) }
  ...
  Scenario: When patron has exceeded their Patron Group Limit for 'Maximum number of items charged out', patron is not allowed to renew items per Conditions settings
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostPatronBlocksLimitsByConditionId') { id: #(limitId), extGroupId: #(groupId), pbcId: #(patronBlockCondition.id), extValue: #(1) }
    ...
    # checkOut the items
    * def checkOutResponse1 = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode1), extCheckOutItemBarcode: #(extItemBarcode1) }
    * def loanId1 = checkOutResponse1.response.id
    * def checkOutResponse2 = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode1), extCheckOutItemBarcode: #(extItemBarcode2) }
    * def loanId2 = checkOutResponse2.response.id
  ...
  Scenario: When patron has exceeded their Patron Group Limit for 'Maximum number of lost items', patron is not allowed to borrow items per Conditions settings
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemBarcode: #(extItemBarcode3) }
  ...
  Scenario: When patron has exceeded their Patron Group Limit for 'Recall overdue by maximum number of days', patron is not allowed to renew items per Conditions settings
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode) }
  ...
  Scenario: When patron has exceeded their Patron Group Limit for 'Maximum outstanding fee/fine balance', patron is not allowed to renew items per Conditions settings
    ...
    * def loanId = checkOutResponse.response.id;
    ...
    # declare the item as lost
    * def declaredLostDateTime = call read('classpath:vega/mod-circulation/eureka-features/util/get-time-now-function.js')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@DeclareItemLost') { loanId: #(loanId), declaredLostDateTime:#(declaredLostDateTime), servicePointId: #(servicePointId) }
  ...
  Scenario: When patron and item id's entered at checkout, execute circulation rules and return the policy to be applied, matching the criteria with the highest priority or the fallback policy
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * def itemData = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode), extMaterialTypeId: #(materialTypeId) }
    ...
    * def locationId = itemData.response.effectiveLocation.id
    ...
    # post a group and a user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: #(groupId) }
    * def userData = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId), extUserBarcode: #(extUserBarcode), extGroupId: #(groupId) }
  ...
  Scenario: Return hours for requested date, next and previous dates openings closest to requested date when calendar/periods/{servicePoint}/calculateopening API called and no exceptions exist to regular hours
    ...
    * def extServicePointId = call uuid1
    ...
    # location and service point setup
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLocation')
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') {extServicePointId: #(extServicePointId)}
    ...
    * def createCalendarRequest = read('classpath:vega/mod-circulation/eureka-features/samples/calendar-and-fixeddue-date-schedules/regular-calendar.json')
    ...
    * def createFixedDueDateSchedulesRequest = read('classpath:vega/mod-circulation/eureka-features/samples/calendar-and-fixeddue-date-schedules/fixed-due-date-schedules.json')
    ...
    * def loanPolicyEntityRequest = read('classpath:vega/mod-circulation/eureka-features/samples/calendar-and-fixeddue-date-schedules/loan-policy-entity-request-with-fddchs.json')
    ...
    * def loan1 = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode1), extLoanDate: #(extLoanDateTime1), extServicePointId: #(extServicePointId) }
    ...
    * def loan2 = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode2), extLoanDate: #(extLoanDateTime2), extServicePointId: #(extServicePointId) }
  ...
  Scenario: Return hours for requested date, next and previous dates openings closest to requested date when calendar/periods/{servicePoint}/calculateopening API called and exceptions exist to regular hours
    ...
    * def endDate = '2022-12-31';
    * def assignments = [#(extServicePointId)]
    * def createCalendarRequest = read('classpath:vega/mod-circulation/eureka-features/samples/calendar-and-fixeddue-date-schedules/calendar-with-exceptions.json')
    Given path 'calendar/calendars'
    And request createCalendarRequest
    When method POST
    Then status 201
    ...
    * def loan3 = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode3), extLoanDate: #(extLoanDateTime3), extServicePointId: #(extServicePointId) }
  ...
  Scenario: When a new circulation rule is entered in the circulation editor, add the rule to the circulation rules record
    ...
    * def loanPolicyEntityRequest = read('classpath:vega/mod-circulation/eureka-features/samples/policies/loan-policy-entity-request.json')
    * loanPolicyEntityRequest.id = newLoanPolicyId
    ...
    * def requestPolicyEntityRequest = read('classpath:vega/mod-circulation/eureka-features/samples/policies/request-policy-entity-request.json')
    ...
    * def patronNoticePolicyEntityRequest = read('classpath:vega/mod-circulation/eureka-features/samples/policies/patron-notice-policy-entity-request.json')
    ...
    * def overdueFinePolicyEntityRequest = read('classpath:vega/mod-circulation/eureka-features/samples/policies/overdue-fine-policy-entity-request.json')
    ...
    * def lostItemFeePolicyEntityRequest = read('classpath:vega/mod-circulation/eureka-features/samples/policies/lost-item-fee-policy-entity-request.json')
