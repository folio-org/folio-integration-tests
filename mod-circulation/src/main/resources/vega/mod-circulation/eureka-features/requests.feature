Feature: Requests tests
  ...
  Background:
    ...
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance')
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { extServicePointId: #(servicePointId) }
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLocation')
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings')
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCancellationReason')
  ...
  Scenario: Given an item Id, a user Id, and a pickup location, attempt to create a page request when the applicable request policy disallows pages
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostMaterialType') { extMaterialTypeId: #(extMaterialTypeId), extMaterialTypeName: #(extMaterialTypeName) }

    # post an item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode), extMaterialTypeId: #(extMaterialTypeId) }

    # post a group and an user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: '#(firstUserGroupId)' }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId), extUserBarcode: #(extUserBarcode), extGroupId: #(firstUserGroupId) }
  ...
  Scenario: Given an item Id, a user Id, and a pickup location, attempt to create a hold request when the applicable request policy disallows holds
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode), extMaterialTypeId: #(extMaterialTypeId) }
    ...
    # post a group and an user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: '#(secondUserGroupId)' }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId), extUserBarcode: #(extUserBarcode), extGroupId: #(secondUserGroupId)  }
  ...
  Scenario: Given an item Id, a user Id, and a pickup location, attempt to create a recall request when the applicable request policy disallows recalls
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode), extMaterialTypeId: #(extMaterialTypeId) }
    ...
    # post a group and an user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: '#(thirdUserGroupId)' }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId), extUserBarcode: #(extUserBarcode), extGroupId: #(thirdUserGroupId) }
  ...
  Scenario: Given an item Id, a user Id, and a pickup location, attempt to create a page request when the applicable request policy allows pages, but items is not of status Available or Recently returned
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostMaterialType') { extMaterialTypeId: #(extMaterialTypeId), extMaterialTypeName: #(extMaterialTypeName) }
    ...
    # post an item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode), extStatusName: #(extStatusName), extMaterialTypeId: #(extMaterialTypeId) }

    # post an user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId), extUserBarcode: #(extUserBarcode), extGroupId: #(fourthUserGroupId) }
  ...
  Scenario Outline: Requests: Given an item Id, a user Id, and a pickup location, attempt to create a hold request when the applicable request policy allows holds, but item is of status "Available", "Recently returned", "In process (not requestable)", "Declared lost", "Lost and paid", "Aged to lost", "Claimed returned", "Missing from ASR", "Long missing", "Retrieving from ASR", "Withdrawn", "Order closed", "Intellectual item", "Unavailable", or "Unknown" (should fail)
    ...
    * def extUserId = call uuid1
    ...
    # post a material type
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostMaterialType') { extMaterialTypeId: #(extMaterialTypeId), extMaterialTypeName:  #(<materialTypeName>) }

    # post an item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(<itemBarcode>), extMaterialTypeId: #(extMaterialTypeId), extStatusName: #(<status>) }

    # post an user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId), extUserBarcode: #(<userBarcode>), extGroupId: #(fourthUserGroupId)  }
  ...
  Scenario Outline: Given an item Id, a user Id, and a pickup location, attempt to create a recall request when the applicable request policy allows recalls, but item is of status "Available", "Recently returned", "Missing", "In process (non-requestable)", "Declared lost", "Lost and paid", "Aged to lost", "Claimed returned", "Missing from ASR", "Long missing", "Retrieving from ASR", "Withdrawn", "Order closed", "Intellectual item", "Unavailable", or "Unknown" (should fail)
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostMaterialType') { extMaterialTypeId: #(extMaterialTypeId), extMaterialTypeName: #(<materialTypeName>) }
    ...
    # post an item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(<itemBarcode>), extStatusName: #(<status>),  extMaterialTypeId: #(extMaterialTypeId) }
  ...
  Scenario Outline: Given an item Id, a user Id, and a pickup location, attempt to create a page request when the applicable request policy allows pages and item status is Available or Recently returned
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostMaterialType') { extMaterialTypeId: #(extMaterialTypeId), extMaterialTypeName: #(<materialTypeName>) }
    ...
    # post an item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(<itemBarcode>), extStatusName: #(<itemStatus>), extMaterialTypeId: #(extMaterialTypeId) }
  ...
  Scenario: Given an item Id, a user Id, and a pickup location, attempt to create a recall request when the applicable request policy allows recalls and item status is "Checked out"
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode) }
    ...
    # post users
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId1), extUserBarcode: #(extUserBarcode1), extGroupId: #(fourthUserGroupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId2), extUserBarcode: #(extUserBarcode2), extGroupId: #(fourthUserGroupId) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId), itemId: #(extItemId), requesterId: #(extUserId2), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingId) }
  ...
  Scenario: Given an item Id, a user Id, and a pickup location, attempt to create a recall request when the applicable request policy allows recalls and item status is "In transit"
    ...
    * def checkInResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@CheckInItem') { itemBarcode: #(extItemBarcode), extServicePointId: #(extServicePointId) }
  ...
  Scenario: Given an item Id, a user Id, and a pickup location, attempt to create a recall request when the applicable request policy allows recalls and item status is "Awaiting pickup"
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId1), extUserBarcode: #(extUserBarcode1), extGroupId: #(fourthUserGroupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId2), extUserBarcode: #(extUserBarcode2), extGroupId: #(fourthUserGroupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId3), extUserBarcode: #(extUserBarcode3), extGroupId: #(fourthUserGroupId) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId1), itemId: #(extItemId), requesterId: #(extUserId2), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingId) }
    ...
    * def response = checkInResponse.response
    ...
    # post a request and verify that the user is allowed to create a recall request
    * def extRequestId = call uuid1
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId), itemId: #(extItemId), requesterId: #(extUserId3), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingId) }
  ...
  Scenario: Given an item Id, a user Id, and a pickup location, attempt to create a recall request when the applicable request policy allows recalls and item status is "Paged"
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId1), itemId: #(extItemId), requesterId: #(extUserId1), extRequestType: #(extRequestType1), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingId) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId2), itemId: #(extItemId), requesterId: #(extUserId2), extRequestType: #(extRequestType2), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingId) }
  ...
  Scenario: Given an item Id, a user Id, and a pickup location, attempt to create a recall request when the applicable request policy allows recalls and item status is "On order"
    ...
    * def extStatusName = 'On order'
    ...
    # post an item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode), extStatusName: #(extStatusName) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId), itemId: #(extItemId), requesterId: #(extUserId), extRequestType: #(extRequestType), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingId) }
  ...
  Scenario: Cancel request
    ...
    * def extRequestLevel = 'Item'
    ...
    # post an item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #('FAT-1040IBC') }

    # post an user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId), extUserBarcode: #('FAT-1040UBC'), extGroupId: #(fourthUserGroupId) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId), itemId: #(extItemId), requesterId: #(extUserId), extRequestType: #(extRequestType), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingId) }
    ...
    # cancel the request
    * def cancelRequestEntityRequest = read('classpath:vega/mod-circulation/eureka-features/samples/cancel-request-entity-request.json')
  ...
  Scenario: Move request to another item on the same instance
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId), itemId: #(extItemId1), requesterId: #(extUserId), extRequestType: #(extRequestType), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingId) }

    # post a move request and verify that request moved to second item
    * def moveRequestEntityRequest = read('classpath:vega/mod-circulation/eureka-features/samples/request/move-request-entity-request.json')
  ...
  Scenario: Generate pick slips for a service point
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLocation') { extLocationId: #(extLocationId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings') { extHoldingSourceId: #(extHoldingSourceId), extHoldingSourceName: #(extHoldingSourceName), extLocationId: #(extLocationId), extHoldingsRecordId: #(extHoldingId)  }

    # post an item
    * def itemRequestResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #(extItemBarcode) }
    ...
    * def extRequestId = call uuid1
    * def extRequestType = 'Page'
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId), itemId: #(extItemId), requesterId: #(extUserId), extRequestType: #(extRequestType), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingId), extServicePoint: #(extServicePoint) }
  ...
  Scenario: Reorder the request queue for an item
    ...
    * def extInstanceId = call uuid
    ...
    # post users
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId1), extUserBarcode: #('FAT-1042UBC'), extGroupId: #(fourthUserGroupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId2), extUserBarcode: #('FAT-1042UBC-2'), extGroupId: #(fourthUserGroupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId3), extUserBarcode: #('FAT-1042UBC-3'), extGroupId: #(fourthUserGroupId) }

    #post an instance
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance') { extInstanceId: #(extInstanceId)}

    # post an item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: #('FAT-1042IBC') }

    # checkout the item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #('FAT-1042UBC'), extCheckOutItemBarcode: #(extItemBarcode) }
    ...
    * def extRequestType = 'Hold'
    * def extRequestLevel = 'Item'
    * def postRequestResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId1), itemId: #(extItemId), requesterId: #(extUserId2), extRequestType: #(extRequestType), extInstanceId: #(extInstanceId), extHoldingsRecordId: #(holdingId) }
    * def postRequestResponse2 = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId2), itemId: #(extItemId), requesterId: #(extUserId3), extRequestType: #(extRequestType), extInstanceId: #(extInstanceId), extHoldingsRecordId: #(holdingId) }

    # reorder the request queue
    * def reorderQueueRequest = read('classpath:vega/mod-circulation/eureka-features/samples/request/reorder-request-queue-entity-request.json')
  ...
  Scenario: Generate hold shelf clearance report for a location
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { servicePointId: #(extServicePointId) }
    ...
    # post user1
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId1), extUserBarcode: #(extUserBarcode), extGroupId: #(fourthUserGroupId) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode), extCheckOutItemBarcode: #(extItemBarcode) }
    ...
    # post user2
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId2), extUserBarcode: #('FAT-1044UBC-2'), extGroupId: #(fourthUserGroupId) }

    # post hold ilr by user2
    * def extRequestId = call uuid1
    * def extRequestType = 'Hold'
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId), itemId: #(extItemId), requesterId: #(extUserId2), extRequestType: #(extRequestType), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingId), extServicePointId:#(extServicePointId) }
  ...
  Scenario: Run tlr-request feature
    * call read('classpath:vega/mod-circulation/eureka-features/tlr-requests.feature')
  ...
  Scenario: VuFind integration - backward compatibility. Requests shouldn't have instanceId, holdingRecordId, requestLevel fields as mandatory
    ...
    * def extRequestType = 'Page'
    ...
    # post an item
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(extItemId), extItemBarcode: 'FAT-2178IBC' }

    # post a user
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(extUserId), extUserBarcode: 'FAT-2178UBC', extGroupId: #(fourthUserGroupId) }

    # post a request
    * def requestEntityRequest = read('classpath:vega/mod-circulation/eureka-features/samples/request/legacy-request-entity-request.json')
    * requestEntityRequest.requesterId = extUserId
    * requestEntityRequest.itemId = extItemId
...
#    * call pause 10000
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PutPatronBlockConditionById') { pbcId: #(patronBlockCondition.id), pbcMessage: #(patronBlockCondition.blockMessage), blockBorrowing: #(false), blockRenewals: #(false), blockRequests: #(true), pbcName: #(patronBlockCondition.name) }
...
#    * call pause 10000
    ...
    * def extRequestType = 'Recall'
    * def extRequestLevel = 'Item'
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId1), itemId: #(extItemId1), requesterId: #(extUserId2), extRequestType: #(extRequestType), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(extRequestId2), itemId: #(extItemId2), requesterId: #(extUserId2), extRequestType: #(extRequestType), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingId) }
    ...
    * def extRequestType = 'Recall'
    * def extRequestLevel = 'Item'
    * def extRequestDate = call read('classpath:vega/mod-circulation/eureka-features/util/get-time-now-function.js')
    * def requestEntityRequest = read('classpath:vega/mod-circulation/eureka-features/samples/request/request-entity-request.json')
    * requestEntityRequest.id = requestId
    * requestEntityRequest.requesterId = extUserId1
    * requestEntityRequest.itemId = extItemId3
...
#    * call pause 10000
    ...
    * def checkOutResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode1), extCheckOutItemBarcode: #(extItemBarcode1) }
    * def loanId = checkOutResponse.response.id;

    # checkOut item2 for user2 so that user1 later could create a request for item2
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode2), extCheckOutItemBarcode: #(extItemBarcode2) }
...
#    * call pause 10000
    ...
    * def headersUser = { 'Content-Type': 'application/json', 'x-okapi-token': '#(okapitoken)', 'x-okapi-tenant': '#(testTenant)', 'Accept': '*/*' }
    * configure headers = headersUser
    * karate.set('headers', headersUser)
    * def extUserId1 = call uuid1
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostPatronBlocksLimitsByConditionId') { id: #(limitId), extGroupId: #(groupId), pbcId: #(patronBlockCondition.id), extValue: #(1) }
    ...
    # checkOut the items
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode1), extCheckOutItemBarcode: #(extItemBarcode1), extLoanDate: #(extLoanDate)  }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(extUserBarcode1), extCheckOutItemBarcode: #(extItemBarcode2), extLoanDate: #(extLoanDate)  }
...
#   * configure headers = headersUser
  # post an owner
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostMaterialType') { extMaterialTypeId: #(materialTypeId1), extMaterialTypeName: #(materialTypeName1) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostMaterialType') { extMaterialTypeId: #(materialTypeId2), extMaterialTypeName: #(materialTypeName2) }
    ...
    * def groupId = call uuid1
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostGroup') { extUserGroupId: #(groupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(userId), extUserBarcode: #(userBarcode), extGroupId: #(groupId) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(requestId1), itemId: #(itemId1), requesterId: #(userId), extRequestType: #(requestType), extRequestLevel: #(requestLevel), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingsRecordId1) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequest') { requestId: #(requestId2), itemId: #(itemId2), requesterId: #(userId), extRequestType: #(requestType), extRequestLevel: #(requestLevel), extInstanceId: #(instanceId), extHoldingsRecordId: #(holdingsRecordId2) }
...
#    * configure headers = headersUser
    ...
    * itemEntityRequest2.effectiveCallNumberComponents.suffix = itemSuffix
    ...
    # post requests
    * def requestId1 = call uuid1
    * def requestEntityRequest1 = read('classpath:vega/mod-circulation/eureka-features/samples/request/request-entity-request.json')
    ...
    * def requestId2 = call uuid1
    * def requestEntityRequest2 = read('classpath:vega/mod-circulation/eureka-features/samples/request/request-entity-request.json')
...
#    * configure headers = headersUser
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(requesterId), extUserBarcode: #(requesterBarcode), extGroupId: #(fourthUserGroupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostUser') { extUserId: #(borrowerId), extUserBarcode: #(borrowerBarcode), extGroupId: #(fourthUserGroupId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostInstance') { extInstanceId: #(instanceId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings') { extHoldingSourceId: #(holdingSourceId), extHoldingSourceName: #(holdingSourceName), extHoldingsRecordId: #(holdingsId), extInstanceId: #(instanceId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(itemId), extItemBarcode: #(itemBarcode), extHoldingsRecordId: #(holdingsId) }
    * def createFirstServicePointResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { extServicePointId: #(firstServicePointId) }
    * def createSecondServicePointResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { extServicePointId: #(secondServicePointId) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { extServicePointId: #(nonPickupLocationServicePointId) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequestPolicy') { extRequestPolicyId: #(newRequestPolicyId), extRequestTypes: ["Page", "Hold", "Recall"], extAllowedServicePoints: {"Page": [#(firstServicePointId), #(secondServicePointId)], "Hold": [#(firstServicePointId), #(nonPickupLocationServicePointId)]} }

    # update non-pickup-location service point with pickup location = false
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PutServicePointNonPickupLocation') { extServicePointId: #(nonPickupLocationServicePointId) }
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostCheckOut') { extCheckOutUserBarcode: #(borrowerBarcode), extCheckOutItemBarcode: #(itemBarcode) }
...
#    * configure headers = headersUser
    ...
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostHoldings') { extHoldingSourceId: #(holdingSourceId), extHoldingSourceName: #(holdingSourceName), extHoldingsRecordId: #(holdingsId), extInstanceId: #(instanceId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostItem') { extItemId: #(itemId), extItemBarcode: #(itemBarcode), extHoldingsRecordId: #(holdingsId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { extServicePointId: #(firstServicePointId) }
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { extServicePointId: #(secondServicePointId) }
    ...
    * def oldCirculationRulesAsText = response.rulesAsText
    ...
    # create request policy with a list of allowed service points
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequestPolicy') { extRequestPolicyId: #(newRequestPolicyId), extRequestTypes: ["Hold", "Page", "Recall"], extAllowedServicePoints: {"Page": [#(firstServicePointId)], "Hold": [#(firstServicePointId)], "Recall": [#(firstServicePointId)]} }
    ...
    * def requestEntity = read('classpath:vega/mod-circulation/eureka-features/samples/request/request-entity-request.json')
...
#    * configure headers = headersUser
    ...
    * def createFirstServicePointResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { extServicePointId: #(firstServicePointId) }
    * def createSecondServicePointResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { extServicePointId: #(secondServicePointId) }
    * def createThirdServicePointResponse = call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostServicePoint') { extServicePointId: #(thirdServicePointId) }

    # create request policy with a list of allowed service points
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequestPolicy') { extRequestPolicyId: #(firstRequestPolicyId), extAllowedServicePoints: {"Hold": [#(firstServicePointId), #(secondServicePointId)], "Recall": [#(thirdServicePointId)]}, extRequestTypes: ["Hold", "Recall"]}
    * call read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequestPolicy') { extRequestPolicyId: #(secondRequestPolicyId), extAllowedServicePoints: {"Hold": [#(secondServicePointId), #(thirdServicePointId)]}, extRequestTypes: ["Hold", "Page"]}
