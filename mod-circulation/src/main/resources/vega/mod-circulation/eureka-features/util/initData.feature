...
#    * configure headers = headersAdmin
  ...
  Scenario: create title level request
    ...
    * def requestEntityRequest = read('classpath:vega/mod-circulation/eureka-features/samples/request/title-level-request-entity-request.json')
    * requestEntityRequest.id = requestId
    * requestEntityRequest.requestType = karate.get('extRequestType', intRequestType)
    * requestEntityRequest.pickupServicePointId = karate.get('extServicePointId', servicePointId)
    * requestEntityRequest.instanceId = karate.get('extInstanceId')
  ...
  Scenario: claim item returned
    ...
    * def claimItemReturnedRequest = read('classpath:vega/mod-circulation/eureka-features/samples/claim-item-returned-entity-request.json')
  ...
  Scenario: refund fee to patron
    ...
    * def refundFeeRequest = read('classpath:vega/mod-circulation/eureka-features/samples/feefine/refund-to-patron-entity-request.json')
  ...
  Scenario: update account
    * def updateAccountRequest = read('classpath:vega/mod-circulation/eureka-features/samples/update-account-entity-request.json')
  ...
  Scenario: create TLR configuration entry
    * def tlrConfigValue = read('classpath:vega/mod-circulation/eureka-features/samples/tlr-config.json')
    ...
    * def tlrConfigEntry = read('classpath:vega/mod-circulation/eureka-features/samples/tlr-config-entry-request.json')
  ...
  Scenario: delete TLR configuration entry
    * def tlrConfig = read('classpath:vega/mod-circulation/eureka-features/samples/tlr-config-entry-request.json')
  ...
  Scenario: create a cancellation reason
    * def cancellationReasonRequest = read('classpath:vega/mod-circulation/eureka-features/samples/cancellation-reason-entity-request.json')
  ...
  Scenario: post create settings to enable checkOutLockFeature
    * def checkoutLockSettingsRequest = read('classpath:vega/mod-circulation/eureka-features/samples/checkout-Lock-settings-request.json')
