...
#    # groups
    ...
    * def fourthUserGroupId = 'a58053e4-6fbc-11ec-90d6-0242ac120001'
    ...
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLoanPolicy') { extLoanPolicyId: #(loanPolicyId) }
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostLoanPolicy') { extLoanPolicyId: #(loanPolicyMaterialId) }
    ...
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequestPolicy') { extRequestPolicyId: #(requestPolicyIdForGroup), extRequestTypes: #(extRequestTypesForFirstUserGroupRequestPolicy) }
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequestPolicy') { extRequestPolicyId: #(requestPolicyIdForGroup2), extRequestTypes: #(extRequestTypesForSecondUserGroupRequestPolicy) }
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequestPolicy') { extRequestPolicyId: #(requestPolicyIdForGroup3), extRequestTypes: #(extRequestTypesForThirdUserGroupRequestPolicy) }
    * callonce read('classpath:vega/mod-circulation/eureka-features/util/initData.feature@PostRequestPolicy') { extRequestPolicyId: #(requestPolicyIdForGroup4) }
