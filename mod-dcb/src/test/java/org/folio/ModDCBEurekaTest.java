...
public class ModDCBEurekaTest extends TestBaseEureka {
  ...
  @Test
  void testPickupFlow() {
    runFeatureTest("pickup-flow.feature");
  }
  ...
  @Test
  void testLendingFlowChainOfResponsibility() {
    runFeatureTest("lending-flow-chain-of-responsibility.feature");
  }

  @Test
  void testBorrowingFlowChainOfResponsibility() {
    runFeatureTest("borrowing-flow-chain-of-responsibility.feature");
  }
