Feature: Testing Lending Flow
  ...
  Scenario: Create Instance
    * def instanceTypeEntityRequest = read('classpath:vega/mod-dcb/features/samples/instance/instance-type-entity-request.json')
    ...
    * def contributorNameTypeEntityRequest = read('classpath:vega/mod-dcb/features/samples/instance/contributor-name-type-entity-request.json')
    ...
    * def instanceEntityRequest = read('classpath:vega/mod-dcb/features/samples/instance/instance-entity-request.json')
  ...
  Scenario: create service point
    * def servicePointEntityRequest = read('classpath:vega/mod-dcb/features/samples/service-point/service-point-entity-request.json')
#    * servicePointEntityRequest.id = karate.get('extServicePointId', servicePointId)
    ...
    * def servicePointEntityRequest1 = read('classpath:vega/mod-dcb/features/samples/service-point/service-point-entity-request.json')
    ...
    * def servicePointEntityRequest2 = read('classpath:vega/mod-dcb/features/samples/service-point/service-point-entity-request.json')
  ...
  Scenario: Create Location
    * def locationUnitInstitutionEntityRequest = read('classpath:vega/mod-dcb/features/samples/location/location-unit-institution-entity-request.json')
    ...
    * def locationUnitCampusEntityRequest = read('classpath:vega/mod-dcb/features/samples/location/location-unit-campus-entity-request.json')
    ...
    * def locationUnitLibraryEntityRequest = read('classpath:vega/mod-dcb/features/samples/location/location-unit-library-entity-request.json')
    ...
    * def locationEntityRequest = read('classpath:vega/mod-dcb/features/samples/location/location-entity-request.json')
  ...
  Scenario: Create Holdings
    * def holdingsEntityRequest = read('classpath:vega/mod-dcb/features/samples/holdings/holdings-entity-request.json')
  ...
  Scenario: create material type
    * def materialTypeEntityRequest = read('classpath:vega/mod-dcb/features/samples/item/material-type-entity-request.json')
  ...
  Scenario: Create Items
    * def permanentLoanTypeEntityRequest = read('classpath:vega/mod-dcb/features/samples/item/permanent-loan-type-entity-request.json')
    ...
    * def itemEntityRequest = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest1 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest2 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest3 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest4 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest5 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest6 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest7 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest8 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest9 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest10 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest11 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest12 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest13 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def itemEntityRequest14 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    * itemEntityRequest14.barcode = itemBarcode121
    * itemEntityRequest14.id = itemId121
    * itemEntityRequest14.holdingsRecordId = karate.get('extHoldingsRecordId', holdingId)
    * itemEntityRequest14.materialType.id = karate.get('extMaterialTypeId', intMaterialTypeId)
    * itemEntityRequest14.status.name = karate.get('extStatusName', intStatusName)

    Given path 'inventory', 'items'
    And request itemEntityRequest14
    When method POST
    Then status 201

  @PostGroup
  Scenario: Create Groups
    * def groupEntityRequest = read('classpath:vega/mod-dcb/features/samples/user/group-entity-request.json')
    ...
    * def groupEntityRequest1 = read('classpath:vega/mod-dcb/features/samples/user/group-entity-request.json')
  ...
  Scenario: create Patron
    * def createPatronGroupRequest = read('classpath:vega/mod-dcb/features/samples/patron/create-patronGroup-request.json')
    Given path 'groups'
  ...
  Scenario: Create Users
    ...
    * def userEntityRequest = read('classpath:vega/mod-dcb/features/samples/user/user-entity-request.json')
    ...
    * def userEntityRequest1 = read('classpath:vega/mod-dcb/features/samples/user/user-entity-request.json')
    ...
    * def userEntityRequest2 = read('classpath:vega/mod-dcb/features/samples/user/user-entity-request.json')
    ...
    * def userEntityRequest3 = read('classpath:vega/mod-dcb/features/samples/user/user-entity-request.json')
    ...
    * def userEntityRequest5 = read('classpath:vega/mod-dcb/features/samples/user/user-entity-request.json')
    ...
    * def userEntityRequest6 = read('classpath:vega/mod-dcb/features/samples/user/user-entity-request.json')
    ...
    * def userEntityRequest7 = read('classpath:vega/mod-dcb/features/samples/user/user-entity-request.json')
    ...
    * def userEntityRequest8 = read('classpath:vega/mod-dcb/features/samples/user/user-entity-request.json')
    ...
    * def userEntityRequest9 = read('classpath:vega/mod-dcb/features/samples/user/user-entity-request.json')
  ...
  Scenario: create a cancellation reason
    * def cancellationReasonRequest = read('classpath:vega/mod-dcb/features/samples/request/cancellation-reason-entity-request.json')
