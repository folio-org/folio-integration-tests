Feature: Pickup role with virtual patron information
  ...
  Scenario: Create DCB Transaction with patron.localNames: Last Name
    ...
    * def response = call read('classpath:vega/mod-dcb/reusable/generate-dcb-transaction.feature@CreatePickupPayloadWithLocalNames') args
  ...
  Scenario: Create DCB Transaction with new patron.localNames for previous patron
    ...
    * def dcbTransaction = call read('classpath:vega/mod-dcb/reusable/generate-dcb-transaction.feature@CreatePickupPayloadWithLocalNames') args
