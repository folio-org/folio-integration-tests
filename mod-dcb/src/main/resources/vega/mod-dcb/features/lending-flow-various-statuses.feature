Feature: Lending transactions for items in various statuses
  ...
  Scenario: Create LENDER transactions for items in various statuses and verify full lending flow
    ...
    * def item1 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def item2 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def item3 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def item4 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def item5 = read('classpath:vega/mod-dcb/features/samples/item/item-entity-request.json')
    ...
    * def localUser630 = read('classpath:vega/mod-dcb/features/samples/user/user-entity-request.json')
    ...
    * def checkOutReq1 = read('classpath:vega/mod-dcb/features/samples/check-out/check-out-by-barcode-entity-request.json')
    ...
    * def intCheckInDate = call read('classpath:vega/mod-dcb/features/util/get-time-now-function.js')
    * def checkInReq3 = read('classpath:vega/mod-dcb/features/samples/check-in/check-in-by-barcode-entity-request.json')
    ...
    * def checkInReq4pre = read('classpath:vega/mod-dcb/features/samples/check-in/check-in-by-barcode-entity-request.json')
    ...
    * def checkInReq5pre = read('classpath:vega/mod-dcb/features/samples/check-in/check-in-by-barcode-entity-request.json')
    ...
    * def txnReq1 = read('classpath:vega/mod-dcb/features/samples/transaction/create-dcb-transaction.json')
    ...
    * def txnReq2 = read('classpath:vega/mod-dcb/features/samples/transaction/create-dcb-transaction.json')
    ...
    * def txnReq3 = read('classpath:vega/mod-dcb/features/samples/transaction/create-dcb-transaction.json')
    ...
    * def txnReq4 = read('classpath:vega/mod-dcb/features/samples/transaction/create-dcb-transaction.json')
    ...
    * def txnReq5 = read('classpath:vega/mod-dcb/features/samples/transaction/create-dcb-transaction.json')
    ...
    * def checkIn1 = read('classpath:vega/mod-dcb/features/samples/check-in/check-in-by-barcode-entity-request.json')
    ...
    * call read('classpath:vega/mod-dcb/reusable/complete-lender-transaction.feature') { txnId: '#(txnId630_1)', itemBarcode: '#(itemBarcode630_1)', checkInServicePointId: '#(servicePointId11)' }
    ...
    * def cancelReq2 = read('classpath:vega/mod-dcb/features/samples/request/cancel-request-entity-request.json')
    ...
    * def checkIn2 = read('classpath:vega/mod-dcb/features/samples/check-in/check-in-by-barcode-entity-request.json')
    ...
    * call read('classpath:vega/mod-dcb/reusable/complete-lender-transaction.feature') { txnId: '#(txnId630_2)', itemBarcode: '#(itemBarcode630_2)', checkInServicePointId: '#(servicePointId11)' }
    ...
    * def checkIn3a = read('classpath:vega/mod-dcb/features/samples/check-in/check-in-by-barcode-entity-request.json')
    ...
    * call read('classpath:vega/mod-dcb/reusable/complete-lender-transaction.feature') { txnId: '#(txnId630_3)', itemBarcode: '#(itemBarcode630_3)', checkInServicePointId: '#(servicePointId11)' }

    # Transaction 4 flow (item was "Awaiting pickup")
    # Cancel the pre-condition request so the item is freed, then check in at sp11.
    * def cancelReq4 = read('classpath:vega/mod-dcb/features/samples/request/cancel-request-entity-request.json')
    ...
    * def checkIn4 = read('classpath:vega/mod-dcb/features/samples/check-in/check-in-by-barcode-entity-request.json')
    ...
    * call read('classpath:vega/mod-dcb/reusable/complete-lender-transaction.feature') { txnId: '#(txnId630_4)', itemBarcode: '#(itemBarcode630_4)', checkInServicePointId: '#(servicePointId11)' }

    # Transaction 5 flow (item was "Awaiting delivery")
    # Cancel the pre-condition delivery request, then check in at sp11.
    * def cancelReq5 = read('classpath:vega/mod-dcb/features/samples/request/cancel-request-entity-request.json')
    ...
    * def checkIn5 = read('classpath:vega/mod-dcb/features/samples/check-in/check-in-by-barcode-entity-request.json')
    ...
    * call read('classpath:vega/mod-dcb/reusable/complete-lender-transaction.feature') { txnId: '#(txnId630_5)', itemBarcode: '#(itemBarcode630_5)', checkInServicePointId: '#(servicePointId11)' }
