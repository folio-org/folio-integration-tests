Feature: Testing Lending Flow Cancellation
  ...
  Scenario: Cancel DCB Transaction manually
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrowing-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: 'abcd' }
  ...
  Scenario: Cancel DCB Transaction manually after OPEN
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrowing-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: '01' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
  ...
  Scenario: Cancel DCB Transaction manually after AWAITING_PICKUP
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrowing-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: '02' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
    * def updateToOpenRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-open.json')
  ...
  Scenario: Cancel DCB Transaction manually after ITEM_CHECKED_OUT
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrowing-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: '03' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
    * def updateToOpenRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-open.json')
  ...
  Scenario: Cancel DCB Transaction manually after ITEM_CHECKED_IN
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrowing-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: '04' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
    * def updateToOpenRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-open.json')
  ...
  Scenario: Cancel DCB Transaction automatically
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrowing-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: '05' }
  ...
  Scenario: Cancel DCB Transaction manually after CLOSED
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrowing-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: '06' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
    * def updateToOpenRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-open.json')
