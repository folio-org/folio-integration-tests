Feature: Non-Lender Role Renew Restriction
  ...
  Scenario: Verify renew returns 400 for BORROWER, BORROWING-PICKUP, and PICKUP roles
    ...
    * def updateToCheckedOutRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-item-check-out.json')

    # Setup: Create BORROWER transaction using real patron (patronId31, patron group 1)
    * def createReqBr = read('classpath:vega/mod-dcb/features/samples/transaction/create-dcb-transaction.json')
    ...
    * def createReqBp = read('classpath:vega/mod-dcb/features/samples/transaction/create-dcb-transaction.json')
    ...
    * def checkOutRequest = read('classpath:vega/mod-dcb/features/samples/check-out/check-out-by-barcode-entity-request.json')
    ...
    * def createReqP = read('classpath:vega/mod-dcb/features/samples/transaction/create-dcb-transaction.json')
