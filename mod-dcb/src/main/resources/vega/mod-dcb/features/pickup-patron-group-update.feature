Feature: Pickup Patron Group Update
  ...
  Scenario: Create two PICKUP transactions for same virtual patron and verify patron group update
    ...
    * def createReq1 = read('classpath:vega/mod-dcb/features/samples/transaction/create-dcb-transaction.json')
    ...
    * url baseUrlNew
    * def createReq2 = read('classpath:vega/mod-dcb/features/samples/transaction/create-dcb-transaction.json')
