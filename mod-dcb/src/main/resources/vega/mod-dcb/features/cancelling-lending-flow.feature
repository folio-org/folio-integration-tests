Feature: Testing Lending Flow Cancellation
  ...
  Scenario: Cancel DCB Transaction manually
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction.feature') { transactionId: '#(transactionId)', extItemId: '#(extItemId1)', itemBarcode: '#(itemBarcode1)' }
  ...
  Scenario: Cancel DCB Transaction automatically
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction.feature') { transactionId: '#(transactionId)', extItemId: '#(extItemId5)', itemBarcode: '#(itemBarcode5)' }
  ...
  Scenario: Cancel DCB Transaction manually after AWAITING_PICKUP
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction.feature') { transactionId: '#(transactionId)', extItemId: '#(extItemId2)', itemBarcode: '#(itemBarcode2)' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
  ...
  Scenario: Cancel DCB Transaction manually after ITEM_CHECKED_OUT
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction.feature') { transactionId: '#(transactionId)', extItemId: '#(extItemId3)', itemBarcode: '#(itemBarcode3)' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
    ...
    * def updateToCheckOutRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-item-check-out.json')
  ...
  Scenario: Cancel DCB Transaction manually after ITEM_CHECKED_IN
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction.feature') { transactionId: '#(transactionId)', extItemId: '#(extItemId4)', itemBarcode: '#(itemBarcode4)' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
