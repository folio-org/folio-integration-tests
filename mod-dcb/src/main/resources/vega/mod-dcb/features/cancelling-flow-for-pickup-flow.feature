Feature: Testing Pickup Flow Cancellation
  ...
  Scenario: Cancel DCB Transaction manually
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: 'A1', userId: '#(id1)', barcode: 'A1' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
  ...
  Scenario: Cancel DCB Transaction manually after OPEN
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: 'B1', userId: '#(id1)', barcode: 'B1' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
  ...
  Scenario: Cancel DCB Transaction manually after AWAITING_PICKUP
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: 'C1', userId: '#(id1)', barcode: 'C1' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')

    * def intCheckInDate = call read('classpath:vega/mod-dcb/features/util/get-time-now-function.js')
    * def checkInRequest = read('classpath:vega/mod-dcb/features/samples/check-in/check-in-by-barcode-entity-request.json')
  ...
  Scenario: Cancel DCB Transaction manually after ITEM_CHECKED_OUT
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: 'D1', userId: '#(id1)', barcode: 'D1' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
    ...
    * def checkOutByBarcodeEntityRequest = read('classpath:vega/mod-dcb/features/samples/check-out/check-out-by-barcode-entity-request.json')
   ...
   Scenario: Cancel DCB Transaction manually after ITEM_CHECKED_IN
     ...
     * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: 'E1', userId: '#(id1)', barcode: 'E1' }
     * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
  ...
  Scenario: Cancel DCB Transaction automatically
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: 'F1', userId: '#(id1)', barcode: 'F1' }
    ...
    * def cancelRequestEntityRequest = read('classpath:vega/mod-dcb/features/samples/request/cancel-request-entity-request.json')
  ...
  Scenario: Cancel DCB Transaction manually after CLOSED
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-pickup.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: 'G1', userId: '#(id1)', barcode: 'G1' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
    * def updateToCloseRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-close.json')
