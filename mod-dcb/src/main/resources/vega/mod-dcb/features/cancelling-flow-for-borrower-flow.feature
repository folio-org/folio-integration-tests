Feature: Testing Borrower Flow Cancellation
  ...
  Scenario: Cancel DCB Transaction manually
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrower.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: '1X' }
  ...
  Scenario: Cancel DCB Transaction manually after OPEN
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrower.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: '2X' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
  ...
  Scenario: Cancel DCB Transaction manually after AWAITING_PICKUP
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrower.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: '3X' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
  ...
  Scenario: Cancel DCB Transaction manually after ITEM_CHECKED_OUT
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrower.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: '4X' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
    ...
    * def updateToItemCheckedOutRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-item-check-out.json')
   ...
   Scenario: Cancel DCB Transaction manually after ITEM_CHECKED_IN
     ...
     * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrower.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: '5X' }
     * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
     ...
     * def updateToItemCheckedInRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-item-check-in.json')
  ...
  Scenario: Cancel DCB Transaction manually after CLOSED
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrower.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: '7X' }
    * def updateToCancelRequest = read('classpath:vega/mod-dcb/features/samples/transaction/update-dcb-transaction-to-cancel.json')
  ...
  Scenario: Cancel DCB Transaction automatically
    ...
    * def createTransaction = call read('classpath:vega/mod-dcb/reusable/create-dcb-transaction-for-borrower.feature') { transactionId: '#(transactionId)', extItemId: '#(id1)', itemBarcode: '6X' }
    Given path 'request-storage', 'requests'
