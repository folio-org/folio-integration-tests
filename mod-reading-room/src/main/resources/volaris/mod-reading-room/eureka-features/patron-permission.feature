Feature: PatronPermission tests
  ...
  Scenario: update patron permission
    ...
    * def patronPermissionEntityRequest = read('classpath:volaris/mod-reading-room/eureka-features/samples/patron-permission/patron-permission-entity-request.json')
