Feature: Scenarios that are primarily focused around exporting list data
  ...
  Scenario: Export should fail if list is refreshing
    * def listRequest = read('classpath:athena/mod-lists/features/samples/user-list.json')
  ...
  Scenario: Export test - Instance - Selected columns
    * def listRequest = read('classpath:athena/mod-lists/features/samples/instance-list.json')
    * def fields = ['instance.hrid', 'instance.title', 'instance.id']
    * def exportResult = call read('classpath:athena/mod-lists/features/util/export-list.feature')
  ...
  Scenario: Export test - Item - Selected columns
    * def listRequest = read('classpath:athena/mod-lists/features/samples/item-list.json')
  ...
  Scenario: Export test - Holdings - Selected columns
    * def listRequest = read('classpath:athena/mod-lists/features/samples/holdings-list.json')
  ...
  Scenario: Export test - Organization - Selected columns
    * def listRequest = read('classpath:athena/mod-lists/features/samples/organization-list.json')
  ...
  Scenario: Export test - Loan - Selected columns
    * def listRequest = read('classpath:athena/mod-lists/features/samples/loan-list.json')
  ...
  Scenario: Export test - POL - Selected columns
    * def listRequest = read('classpath:athena/mod-lists/features/samples/pol-list.json')
  ...
  Scenario: Export test - MARC bib - MARC tag fields
    ...
    * def listRequest = read('classpath:athena/mod-lists/features/samples/marc-list.json')
