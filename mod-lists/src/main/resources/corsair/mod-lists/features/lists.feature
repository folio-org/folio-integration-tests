Feature: List App list tests
  ...
  Background:
    ...
    * def loanListId = '97f5829f-1510-47bc-8454-ae7fa849baef'
    # For some reason, the first refresh always hangs (seemingly only when run with mod-fqm-manager too). This is a workaround
    * def listRequest = read('samples/loan-list-request.json')
    * def dummyPostCall = callonce postList
    * def dummyListId = dummyPostCall.listId
    * callonce refreshList {listId: '#(dummyListId)'}
#    * callonce cancelRefresh {listId: '#(dummyListId)'}
  ...
  Scenario: Post and get new list
    ...
    * def listId = postCall.listId
    ...
    And match $.userFriendlyQuery == '(loan_status == Open)'
  ...
  Scenario: Get all lists for tenant with active query parameter
    * configure afterScenario = () => karate.call('delete-list.feature', {listId: listId})
    * def listRequest = read('samples/private-list-request.json')
    * def postCall = call read('post-list.feature')
    * def listId = postCall.listId
...
#
#    Given path 'users/' + userId1
#    When method DELETE
#    Then status 204
#
#    Given path 'users/' + userId2
#    When method DELETE
#    Then status 204
#
#    Given path 'users/' + userId3
#    When method DELETE
#    Then status 204
...
#    * def listId = $.id
#    * configure afterScenario = () => karate.call("classpath:/delete-list.feature", {listId: listId})
#
#    # Refresh list
#    * call refreshList {listId: '#(listId)'}
#
...
#
#    Given path 'lists/' + listId
#    And request {name: 'Updated Integration Test List', isActive:  'true', isPrivate: 'false', version: 1, fqlQuery: "{\"item_status\": {\"$in\": [\"missing\", \"lost\"]}}"}
#    When method PUT
#    Then status 200
#    And match $.userFriendlyQuery == '#present'
#
...
#  Scenario: Post list, refresh list, export list, delete list 2
#    * def listRequest = read('samples/loan-list-request.json')
#    * def postCall = call postList
#    * def listId = postCall.listId
#    * configure afterScenario = () => karate.call("delete-list.feature", {listId: listId})
...
#    And match $.status == 'SUCCESS'
#
#  Scenario: Post list, refresh list, export list, delete list 3
#    * def listRequest = read('samples/loan-list-request.json')
#    * def postCall = call postList
#    * def listId = postCall.listId
#    * configure afterScenario = () => karate.call("delete-list.feature", {listId: listId})
...
#    And match $.status == 'SUCCESS'
#
#  Scenario: Post list, refresh list, export list, delete list 4
#    * def listRequest = read('samples/loan-list-request.json')
#    * def postCall = call postList
#    * def listId = postCall.listId
#    * configure afterScenario = () => karate.call("delete-list.feature", {listId: listId})
...
#    And match $.status == 'SUCCESS'
#
#  Scenario: Post list, refresh list, export list, delete list 5
#    * def listRequest = read('samples/loan-list-request.json')
#    * def postCall = call postList
#    * def listId = postCall.listId
#    * configure afterScenario = () => karate.call("delete-list.feature", {listId: listId})
...
#    And match $.status == 'SUCCESS'
#
#  Scenario: Post list, refresh list, export list, delete list 6
#    * def listRequest = read('samples/loan-list-request.json')
#    * def postCall = call postList
#    * def listId = postCall.listId
#    * configure afterScenario = () => karate.call("delete-list.feature", {listId: listId})
...
#    And match $.status == 'SUCCESS'
#
#  Scenario: Post list, refresh list, export list, delete list 7
#    * def listRequest = read('samples/loan-list-request.json')
#    * def postCall = call postList
#    * def listId = postCall.listId
#    * configure afterScenario = () => karate.call("delete-list.feature", {listId: listId})
...
#    And match $.status == 'SUCCESS'
#
#  Scenario: Post list, refresh list, export list, delete list 8
#    * def listRequest = read('samples/loan-list-request.json')
#    * def postCall = call postList
#    * def listId = postCall.listId
#    * configure afterScenario = () => karate.call("delete-list.feature", {listId: listId})
...
#    And match $.status == 'SUCCESS'
#
#  Scenario: Post list, refresh list, export list, delete list 9
#    * def listRequest = read('samples/loan-list-request.json')
#    * def postCall = call postList
#    * def listId = postCall.listId
#    * configure afterScenario = () => karate.call("delete-list.feature", {listId: listId})
