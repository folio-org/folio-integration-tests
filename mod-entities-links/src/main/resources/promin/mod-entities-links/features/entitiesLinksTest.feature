Feature: instance-links tests
  ...
  Background:
    ...
    * def samplePath = 'classpath:promin/mod-entities-links/features/samples'
    * def utilPath = 'classpath:promin/mod-entities-links/features/samples/util/base.feature'
