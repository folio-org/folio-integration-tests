function fn() {
  ...
  var config = {
    ...
    apikey: 'eyJzIjoiVExodW1JV2JiTCIsInQiOiJ0ZXN0b2FpcGgxMyIsInUiOiJ0ZXN0LXVzZXIxMyJ9',
    testTenant: 'testoaipmh',
    testTenantId: (function() { return java.util.UUID.randomUUID() + '' })(),
    testAdmin: {tenant: testTenant, name: 'test-admin', password: 'admin'},
    testUser: {tenant: testTenant, name: 'test-user13', password: 'test13'},
  ...
  if (env == 'snapshot-2') {
    ...
    config.apikey = 'eyJzIjoiVExodW1JV2JiTCIsInQiOiJ0ZXN0b2FpcGgxMyIsInUiOiJ0ZXN0LXVzZXIxMyJ9';
    config.admin = {
      tenant: 'supertenant',
      name: 'testing_admin',
      password: 'admin'
