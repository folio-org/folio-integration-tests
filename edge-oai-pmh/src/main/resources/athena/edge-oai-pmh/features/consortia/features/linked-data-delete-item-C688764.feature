Feature: Delete item from shared LINKED_DATA instance
  ...
  @C688764
  Scenario: Consortia | ListRecords: Verify that delete Item of shared LINKED_DATA Instance is retrieved in single tenant and cross-tenant harvests
    ...
    * configure headers = headersUniversity
    ...
    # Create holdings and item in member tenant as precondition
