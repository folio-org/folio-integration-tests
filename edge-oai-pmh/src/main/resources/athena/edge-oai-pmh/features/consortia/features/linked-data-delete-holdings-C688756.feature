Feature: Delete holdings from shared LINKED_DATA instance
  ...
  @C688756
  Scenario: Consortia | ListRecords: Verify that delete Holdings of shared LINKED_DATA Instance is retrieved in single tenant and cross-tenant harvests
    ...
    * configure headers = headersUniversity
    ...
    # Create holdings in member tenant as precondition
    ...
    * def from = isoDate()
    ...
    # Delete holdings record in member tenant
