Feature: edge-oai-pmh ECS tests
  ...
  Scenario: Update hrId for all tenants
    * call login consortiaAdmin
    * call read('classpath:athena/edge-oai-pmh/features/consortia/hrid-util.feature@UpdateHrId') { tenant: '#(centralTenant)', prefix: 'cons' }

    * call login universityUser1
    * call read('classpath:athena/edge-oai-pmh/features/consortia/hrid-util.feature@UpdateHrId') { tenant: '#(universityTenant)', prefix: 'u' }

    * call login collegeUser1
    * call read('classpath:athena/edge-oai-pmh/features/consortia/hrid-util.feature@UpdateHrId') { tenant: '#(collegeTenant)', prefix: 'o' }

  Scenario: Create reference data
    Given call read('classpath:athena/edge-oai-pmh/features/init_data/create-reference-data.feature') { testUser : '#(consortiaAdmin)' }
    Given call read('classpath:athena/edge-oai-pmh/features/init_data/create-reference-data.feature') { testUser : '#(universityUser1)' }
    Given call read('classpath:athena/edge-oai-pmh/features/init_data/create-reference-data.feature') { testUser : '#(collegeUser1)' }