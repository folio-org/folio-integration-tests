...
Feature: oai-pmh basic tests
  ...
  Background:
    ...
    * callonce read('classpath:athena/oaipmh/verbs/get_record.feature')
    * callonce read('classpath:athena/oaipmh/verbs/identify.feature')
    * callonce read('classpath:athena/oaipmh/verbs/list_identifiers.feature')
    * callonce read('classpath:athena/oaipmh/verbs/list_records.feature')
    * callonce read('classpath:athena/oaipmh/verbs/list_sets.feature')
    * callonce read('classpath:athena/oaipmh/verbs/metadata_prefix.feature')
