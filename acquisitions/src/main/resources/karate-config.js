function fn() {
  ...
  var testTenant = karate.properties['testTenant'] || 'testtenant1321136017817912274';
  var testTenantId = karate.properties['testTenantId'] || '41f65988-b92a-4154-a9f4-92e604dd898a';
