Feature: open-order-multy-loc-mixed-and-manual-piece-false-and-create-inventory-inst-hold-items-only-for-physical-elec-inst.
  ...
  Scenario: Create order line
    ...
    * set orderLine.eresource.createInventory = 'Instance'
