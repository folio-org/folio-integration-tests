Feature: open-order-multy-location-mixed-and-manual-piece-false-and-create-inventory-instance.
  ...
  Scenario: Check that instances, items, pieces, holdings were created
    ...
    * match poLineResp.locations[1].locationId == "#(globalLocationsId2)"
    * match poLineResp.locations[1] !contains { holdingId: '#notnull' }
