Feature: global inventory
  ...
  Scenario: create locations
    * table locations
      ...
      | 'b32c5ce2-6738-42db-a291-2796b1c3c4c6' | 'LOC1' | '40ee00ca-a518-4b49-be01-0638d0a4ac57' | '62cf76b7-cca5-4d33-9217-edf42ce1a848' | '5d78803e-ca04-4b4a-aeae-2c63b924518b' | '3a40852d-49fd-4df2-a1f9-6e2641a6e91f'
      | 'b32c5ce2-6738-42db-a291-2796b1c3c4c8' | 'LOC2' | '40ee00ca-a518-4b49-be01-0638d0a4ac57' | '62cf76b7-cca5-4d33-9217-edf42ce1a848' | '5d78803e-ca04-4b4a-aeae-2c63b924518b' | '3a40852d-49fd-4df2-a1f9-6e2641a6e91f'
      | 'b32c5ce2-6738-42db-a291-2796b1c3c4c9' | 'LOC3' | '40ee00ca-a518-4b49-be01-0638d0a4ac57' | '62cf76b7-cca5-4d33-9217-edf42ce1a848' | '5d78803e-ca04-4b4a-aeae-2c63b924518b' | '3a40852d-49fd-4df2-a1f9-6e2641a6e91f'
    * def v = call createLocation locations

  Scenario: Create instances
    * table instances
      | id                                     | title        | instanceTypeId
      | 'd6635cf1-b775-46ac-94e5-adaffee111cd' | 'instance 1' | '6d6f642d-0000-1111-aaaa-6f7264657273'
    * def v = call createInstance instances

  Scenario: Create holdings
    * table holdings
      | id                                     | instanceId                             | locationId                              | sourceId
      | '59e2c91d-d1dd-4e1a-bbeb-67e8b4dcd111' | 'd6635cf1-b775-46ac-94e5-adaffee111cd' | 'b32c5ce2-6738-42db-a291-2796b1c3c4c6' | 'f32d531e-df79-46b3-8932-cdd35f7a2264'
      | '59e2c91d-d1dd-4e1a-bbeb-67e8b4dcd222' | 'd6635cf1-b775-46ac-94e5-adaffee111cd' | 'b32c5ce2-6738-42db-a291-2796b1c3c4c6' | 'f32d531e-df79-46b3-8932-cdd35f7a2264'
      | '59e2c91d-d1dd-4e1a-bbeb-67e8b4dcd333' | 'd6635cf1-b775-46ac-94e5-adaffee111cd' | 'b32c5ce2-6738-42db-a291-2796b1c3c4c6' | 'f32d531e-df79-46b3-8932-cdd35f7a2264'
