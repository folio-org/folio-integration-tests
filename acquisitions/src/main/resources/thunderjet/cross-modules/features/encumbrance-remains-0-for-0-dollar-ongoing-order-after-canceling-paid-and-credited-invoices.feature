...
Feature: Encumbrance remains 0 for an $0 Ongoing order when paid and credited invoices exist and after invoices cancelation (release encumbrance = false)
  ...
  @Positive
  Scenario: Encumbrance remains 0 for an $0 Ongoing order when paid and credited invoices exist and after invoices cancelation (release encumbrance = false)
