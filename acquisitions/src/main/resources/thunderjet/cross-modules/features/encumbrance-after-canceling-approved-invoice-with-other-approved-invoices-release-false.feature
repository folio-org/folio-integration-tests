# For MODFISTO-542, https://foliotest.testrail.io/index.php?/cases/view/1028984
Feature: Encumbrance Is Calculated Correctly After Canceling An Approved Invoice When Other Approved Invoices Exist Release False
  ...
  Scenario: Encumbrance Is Calculated Correctly After Canceling An Approved Invoice When Other Approved Invoices Exist Release False
    ...
    * def validateEncumbranceAfterCancel3 =
    ...
    function(response) {
      ...
      return transaction.amount == -10.00 &&
             ...
             transaction.encumbrance.amountAwaitingPayment == 110.00 &&
    ...
    # 9. Cancel Invoice 2
    * print '9. Cancel Invoice 2'
    * def v = call cancelInvoice { invoiceId: "#(invoice2Id)" }

    # 10. Verify Encumbrance State After Cancelling Invoice 2
    * print '10. Verify Encumbrance State After Cancelling Invoice 2'
    * def validateEncumbranceAfterCancel2 =
    ...
    # 11. Cancel Invoice 1
    * print '11. Cancel Invoice 1'
    * def v = call cancelInvoice { invoiceId: "#(invoice1Id)" }

    # 12. Verify Encumbrance State After Cancelling Invoice 1
    * print '12. Verify Encumbrance State After Cancelling Invoice 1'
