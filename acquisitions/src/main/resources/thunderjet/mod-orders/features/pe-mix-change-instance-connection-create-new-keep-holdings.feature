# For MODORDERS-1300, https://foliotest.testrail.io/index.php?/cases/view/784422
Feature: P/E Mix Change Instance Connection Create New Keep Holdings
  ...
  @C784422
  @Positive
  Scenario: P/E Mix Order Change Instance To Existing With Create New Holdings And Keep Abandoned Holdings
    ...
    * def v = call createInstance { id: '#(instanceId)', title: 'Instance C784422', instanceTypeId: '#(globalInstanceTypeId)' }
