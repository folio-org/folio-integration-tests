...
class GobiExtendedApiTest extends TestBaseEureka implements AcquisitionsTest {
  ...
  private static final String[] FEATURES = {
    "receipt-not-required-pending-order-independent-workflow",
    "receipt-not-required-open-order-independent-workflow",
    "order-without-location-fails-when-holdings-required",
    "order-without-configured-locations",
    "tenant-id-not-populated-on-non-ecs"
  };
