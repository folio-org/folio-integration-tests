...
Feature: Test export authority deleted
  ...
  Scenario: Test export deleted authority
    ...
    * call read('classpath:global/inventory_data_setup_util.feature@PostAuthority1') {authorityId:'#(authorityId)'}
    * call read('classpath:global/mod_srs_init_data.feature@PostMarcAuthorityRecord1') {recordId:'#(authorityRecordId)', snapshotId:'#(snapshotId)', authorityId:'#(authorityId)'}
