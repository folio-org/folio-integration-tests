...
#   Actual URL: users?limit=100&query=((username="aaa*" or personal.firstName="aaa*" or personal.preferredFirstName="aaa*" or personal.lastName="aaa*" or personal.email="aaa*" or barcode="aaa*" or id="aaa*" or externalSystemId="aaa*" or customFields="aaa*"))
