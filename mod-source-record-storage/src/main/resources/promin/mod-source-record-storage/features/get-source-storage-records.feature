Feature: Source-Record-Storage
  ...
  Background:
    ...
    * def samplesPath = 'classpath:promin/mod-source-record-storage/features/samples/'
    ...
    * def postInstanceFeature = read('classpath:promin/mod-source-record-storage/features/global/postToInventory.feature')
