Feature: Test POST password validate
  ...
  Background:
    ...
    * def testRuleFailure = 'classpath:spitfire/passwordvalidator/test-rule-failure-eureka.feature'
    * def testRuleFailureOnPasswordCheck = 'classpath:spitfire/passwordvalidator/test-rule-failure-on-password-check-eureka.feature'
