...
public class ConsortiaInventoryEurekaTest extends TestBaseEureka {
  private static final String TEST_BASE_PATH = "classpath:folijet/mod-inventory/eureka-features/consortia/";

  public ConsortiaInventoryEurekaTest() {
