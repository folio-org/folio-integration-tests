Feature: Authority assignment check
  ...
  Background:
    ...
    * def personMarcString = karate.readAsString('classpath:promin/mod-linked-data/features/authority-assignment-check/samples/marc_authority_person.json')
    * def familyMarcString = karate.readAsString('classpath:promin/mod-linked-data/features/authority-assignment-check/samples/marc_authority_family.json')
    * def orgMarcString = karate.readAsString('classpath:promin/mod-linked-data/features/authority-assignment-check/samples/marc_authority_organization.json')
    * def jurisdictionMarcString = karate.readAsString('classpath:promin/mod-linked-data/features/authority-assignment-check/samples/marc_authority_jurisdiction.json')
    * def meetingMarcString = karate.readAsString('classpath:promin/mod-linked-data/features/authority-assignment-check/samples/marc_authority_meeting.json')
    * def topicMarcString = karate.readAsString('classpath:promin/mod-linked-data/features/authority-assignment-check/samples/marc_authority_topic.json')
    * def placeMarcString = karate.readAsString('classpath:promin/mod-linked-data/features/authority-assignment-check/samples/marc_authority_place.json')
    * def formMarcString = karate.readAsString('classpath:promin/mod-linked-data/features/authority-assignment-check/samples/marc_authority_form.json')
    * def hubMarcString = karate.readAsString('classpath:promin/mod-linked-data/features/authority-assignment-check/samples/marc_authority_hub.json')
