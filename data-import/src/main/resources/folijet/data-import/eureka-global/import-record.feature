Feature: Util feature to import records
  ...
  Scenario: Import record
    ...
    * call read('classpath:folijet/data-import/eureka-global/common-data-import.feature') ({ fileName: fileName, filePathFromSourceRoot: filePathFromSourceRoot, uiKey: '' })
    ...
    * call read('classpath:folijet/data-import/eureka-features/get-completed-job-execution-for-key.feature') { key: '#(s3UploadKey)' }
