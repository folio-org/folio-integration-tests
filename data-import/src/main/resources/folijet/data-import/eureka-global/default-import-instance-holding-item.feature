Feature: Util feature to import instance, holding, item. Based on FAT-937 scenario steps.
  ...
  Scenario: Import Instance, Holdings, Items. Based on FAT-937 scenario steps.
    ...
    * def result = call read('classpath:folijet/data-import/eureka-global/common-data-import.feature') {headersUser: '#(headersUser)', headersUserOctetStream: '#(headersUserOctetStream)', uiKey : '#(uiKey)', fileName: '#(fileName)', 'filePathFromSourceRoot' : '#(filePathFromSourceRootName)'}
