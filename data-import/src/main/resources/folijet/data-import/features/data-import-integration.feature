Feature: Data Import integration tests
  ...
  Scenario: FAT-945 Match MARC-to-MARC and update Instances, Holdings, fail to update Items
    ...
    * def matchProfileIdMarcToMarc = $.id
    ...
    # Create match profile for MARC-to-Holdings 901a to Holdings HRID (wrong match)
    Given path 'data-import-profiles/matchProfiles'
    And headers headersUser
    And request
    """
  ...
  Scenario: MODINV-1094_update Match MARC-to-Instance by Cancelled LCCN and update Instance with Suppress From Discovery
    * print 'MODINV-1094_update Match MARC-to-Instance by Cancelled LCCN and update Instance with Suppress From Discovery'
    ...
    And request
      ...
      {
        "profile": {
          "name": "MODINV-1094_update: MARC-to-Instance",
          "incomingRecordType": "MARC_BIBLIOGRAPHIC",
          "existingRecordType": "INSTANCE",
          "description": "",
          "mappingDetails": {
    ...
    * def profileAction = 'UPDATE'
    * def folioRecord = 'INSTANCE'
    * def userStoryNumber = 'MODINV-1094_update'
    * def folioRecordNameAndDescription = folioRecord + ' action profile for ' + userStoryNumber
    And request read('classpath:folijet/data-import/samples/samples_for_upload/create_action_profile.json')
    When method POST
    Then status 201
    * def instanceActionProfileId = $.id
    ...
    And request
      ...
      {
        "profile": {
          "name": "MODINV-1094_update: Match Profile",
          "description": "",
          "incomingRecordType": "MARC_BIBLIOGRAPHIC",
          "matchDetails": [
            {
    ...
    * def instanceMatchProfileId = $.id
    ...
    # Create job profile
    * def jobProfileUpdateName = "MODINV-1094_update: Job profile"
    Given path 'data-import-profiles/jobProfiles'
    And headers headersUser
    And request
      """
    ...
    * def createInstanceJobProfileId = 'e34d7b92-9b83-11eb-a8b3-0242ac130003'
    ...
    # Import file
    * def jobProfileId = createInstanceJobProfileId
    Given call read(utilFeature+'@ImportRecord') { fileName:'MODINV-1094_update', jobName:'customJob' }
    Then match status != 'ERROR'
    ...
    * def instanceId = response.instances[0].id
    ...
    Given path 'data-export/mapping-profiles'
    And headers headersUser
    * def exportMappingProfileName = 'MODINV-1094_update Mapping instance for export'
    And request read('classpath:folijet/data-import/samples/profiles/data-export-mapping-profile.json')
    When method POST
    Then status 201
    * def dataExportMappingProfileId = $.id
    ...
    And request
      """
      {
        "name": "MODINV-1094_update Data-export job profile",
        "destination": "fileSystem",
        "description": "Job profile description",
        "mappingProfileId": "#(dataExportMappingProfileId)"
      }
    ...
    * print 'Export MARC record by instance id'
    ...
    And request
      """
      {
        ...
        "type": "uuid",
        "recordType": "INSTANCE",
        "fileName": "MODINV-1094_update.mrc",
      }
      """
    When method POST
    Then status 200
    * def exportJobExecutionId = $.jobExecutionId
    ...
    Then status 200
    * def downloadLink = $.link
    * def fileName = 'MODINV-1094_update.mrc'
    ...
    * def filePath = 'file:target/' + fileName
    ...
    # Create file definition for MODINV-1094_update.mrc-file
    * print 'Before Forwarding : ', 'uiKey : ', uiKey, 'name : ', fileName
    * def result = call read(commonImportFeature) {headersUser: '#(headersUser)', headersUserOctetStream: '#(headersUserOctetStream)', uiKey: '#(uiKey)', fileName: '#(fileName)', 'filePathFromSourceRoot': '#(filePath)'}
