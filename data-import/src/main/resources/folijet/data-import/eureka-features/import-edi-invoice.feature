Feature: Import EDIFACT invoice
  ...
  Scenario: EDI invoice import
    ...
    * call read('classpath:folijet/data-import/eureka-global/common-data-import.feature') {headersUser: '#(headersUser)', headersUserOctetStream: '#(headersUserOctetStream)', uiKey : '#(uiKey)', fileName: 'FAT-968.edi', 'filePathFromSourceRoot' : 'classpath:folijet/data-import/samples/edi-files/FAT-968.edi'}
  ...
  Scenario: FAT-1140 Import EDIFACT file with multiple fields mapping into 1 invoice field with space
    ...
    * call read('classpath:folijet/data-import/eureka-global/common-data-import.feature') {headersUser: '#(headersUser)', headersUserOctetStream: '#(headersUserOctetStream)', uiKey : '#(uiKey)', fileName: 'FAT-1140.edi', 'filePathFromSourceRoot' : 'classpath:folijet/data-import/samples/edi-files/FAT-1140.edi'}
  ...
  Scenario: FAT-1141 Import EDIFACT file with multiple fields mapping into 1 invoice field with hyphen
    ...
    * call read('classpath:folijet/data-import/eureka-global/common-data-import.feature') {headersUser: '#(headersUser)', headersUserOctetStream: '#(headersUserOctetStream)', uiKey : '#(uiKey)', fileName: 'FAT-1141.edi', 'filePathFromSourceRoot' : 'classpath:folijet/data-import/samples/edi-files/FAT-1141.edi'}
  ...
  Scenario: FAT-1470 Import of invoices with acquisitions unit
    ...
    * call read('classpath:folijet/data-import/eureka-global/common-data-import.feature') {headersUser: '#(headersUser)', headersUserOctetStream: '#(headersUserOctetStream)', uiKey : '#(uiKey)', fileName: 'FAT-1470.edi', 'filePathFromSourceRoot' : 'classpath:folijet/data-import/samples/edi-files/FAT-1470.edi'}
