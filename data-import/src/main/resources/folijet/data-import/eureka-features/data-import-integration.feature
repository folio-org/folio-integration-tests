Feature: Data Import integration tests
  ...
  Background:
    ...
    * def exportRecordFeature = 'classpath:folijet/data-import/eureka-global/export-record.feature'
    * def createExportMappingProfile = read('classpath:folijet/data-import/eureka-global/data-export-profiles.feature@createMappingProfile')
    * def createExportJobProfile = read('classpath:folijet/data-import/eureka-global/data-export-profiles.feature@createJobProfile')
  ...
  Scenario: FAT-1204 Import MARC file, match on location, update Holdings and Item locations
    ...
    * call read('classpath:folijet/data-import/eureka-features/get-completed-job-execution.feature@getJobWhenJobStatusCompleted') { jobExecutionId: '#(jobExecutionId)'}
    * def jobExecution = response
    And assert jobExecution.status == 'COMMITTED'
    And assert jobExecution.uiStatus == 'RUNNING_COMPLETE'
