Feature: Test matching by POL number and vendor reference number
  ...
  Scenario: FAT-2184 Match on POL and update related Instance, Holdings, Item
    # Create order
    * def result = call read('classpath:folijet/data-import/eureka-global/create-order.feature') {poNumber: 'FAT2184pref10000', vendorId: 'c6dace5d-4574-411e-8ba1-036102fcdc9b'}
    ...
    * def orderLineParams =
    ...
    """
    * call read('classpath:folijet/data-import/eureka-global/create-order-line.feature') orderLineParams
    ...
    * def result = call read('classpath:folijet/data-import/eureka-global/common-data-import.feature') {headersUser: '#(headersUser)', headersUserOctetStream: '#(headersUserOctetStream)', uiKey: '#(uiKey)', fileName: '#(fileName)', 'filePathFromSourceRoot': '#(filePath)'}
    ...
    * call read('classpath:folijet/data-import/eureka-features/get-completed-job-execution-for-key.feature@getJobWhenJobStatusCompleted') {key: '#(sourcePath)'}
  ...
  Scenario: FAT-2183 Match on VRN and update related Instance, Holdings, Item
    # Create order
    * def result = call read('classpath:folijet/data-import/eureka-global/create-order.feature') {poNumber: 'FAT2183pref10000', vendorId: 'c6dace5d-4574-411e-8ba1-036102fcdc9b'}
    * def createdOrder = result.response
    ...
    * def orderLineParams =
    ...
    """
    * call read('classpath:folijet/data-import/eureka-global/create-order-line-with-vrn.feature') orderLineParams
  ...
  Scenario: FAT-13844 Match on POL and VRN and update related Instance
    # Create order
    * def result = call read('classpath:folijet/data-import/eureka-global/create-order.feature') {poNumber: 'FAT13844pref1000', vendorId: 'c6dace5d-4574-411e-8ba1-036102fcdc9b'}
    * def createdOrder = result.response
