Feature: mod-data-import integration tests
  ...
  Background:
    ...
    * table userPermissions
      ...
      | 'metadata-provider.jobsummary.get'                                    |
  ...
  Scenario: init global data
    ...
    * callonce read('classpath:promin/data-import/global/mod_inventory_init_data.feature')
    * callonce read('classpath:promin/data-import/global/init-acquisition-data.feature')
