Feature: Data Import Log deletion tests
  ...
  Scenario: FAT-1616 Deleting data-import logs
    ...
    * def result = call read('classpath:promin/data-import/global/common-data-import.feature') {headersUser: '#(headersUser)', headersUserOctetStream: '#(headersUserOctetStream)', uiKey : '#(uiKey)', fileName: '#(fileName)', 'filePathFromSourceRoot' : 'classpath:promin/data-import/samples/mrc-files/FAT-937.mrc'}
