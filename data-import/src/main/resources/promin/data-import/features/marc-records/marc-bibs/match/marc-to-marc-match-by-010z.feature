Feature: MARC-to-MARC match by 010$z
  ...
  Scenario: Update of file using marc-to-marc match by 010$z
  ...
  Scenario: Update of file using marc-to-marc match by 010$z with multiple matches - update applied
  ...
  Scenario: Update of file using marc-to-marc match by 010$z with multiple matches - update rejected
    * print 'Match MARC-to-Instance by Cancelled LCCN and update Instance - update rejected due to multiple matches'
