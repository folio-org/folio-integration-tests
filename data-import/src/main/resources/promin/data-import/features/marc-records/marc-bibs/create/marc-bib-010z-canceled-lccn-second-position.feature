Feature: Import of file with 010$z mapped for canceled LCCN in second position
  ...
  Scenario: Import of file with 010$z should mapped for canceled LCCN in second position
