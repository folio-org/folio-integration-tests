Feature: Mapping for item record notes and check in/out notes from MARC field
  ...
  Scenario: Verify the mapping for item record notes and check in/out notes from MARC field
