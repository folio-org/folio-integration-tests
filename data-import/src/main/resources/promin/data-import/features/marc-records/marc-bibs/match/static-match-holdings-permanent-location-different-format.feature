Feature: Static match on Holdings permanent location with different format
  ...
  Scenario: Test import with static match on Holdings permanent location with different format
