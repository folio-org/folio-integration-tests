Feature: Verify mapping of contributors from MARC 720 fields with relator terms and codes
  ...
  @C366547
  Scenario: Verify mapping of contributors from MARC 720 fields (Personal/Corporate names with relator terms and codes)
    ...
    * def expectedSourceByOrder = [ '#(expectedSourceRecord1)', '#(expectedSourceRecord2)', '#(expectedSourceRecord3)' ]
    ...
    # ============================================================================
    * def selfFeature = 'classpath:promin/data-import/features/marc-records/marc-bibs/create/contributors-720-relator-terms-and-codes.feature'
