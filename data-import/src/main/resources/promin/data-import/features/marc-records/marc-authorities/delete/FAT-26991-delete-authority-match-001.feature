...
Feature: FAT-26991 Delete MARC Authority records matched by 001
  ...
  # action profile sits under a match profile on 001, and verifies that the matched authority is
  ...
  Scenario: Delete MARC Authority matched by 001
    ...
    * def deleteFile = javaWriteData.setFieldValueByControlNumber(exportedFile, controlControlNumber, '001', ' ', 'FAT26991N' + runId)
