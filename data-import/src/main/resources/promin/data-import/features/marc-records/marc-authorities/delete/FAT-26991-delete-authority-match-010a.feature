...
Feature: FAT-26991 Delete MARC Authority records matched by 010 $a
  ...
  # action profile sits under a match profile on 010 $a, and verifies that the matched authority is
  ...
  Scenario: Delete MARC Authority matched by 010 $a
    ...
    * def deleteFile = javaWriteData.setFieldValueByControlNumber(exportedFile, controlControlNumber, '010', 'a', 'fat26991n' + runId)
