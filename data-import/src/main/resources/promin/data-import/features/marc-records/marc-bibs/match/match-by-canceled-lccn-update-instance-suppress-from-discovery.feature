Feature: Match MARC-to-Instance by Cancelled LCCN and update Instance with Suppress From Discovery
  ...
  Scenario: Match MARC-to-Instance by Cancelled LCCN and update Instance with Suppress From Discovery
    * print 'Match MARC-to-Instance by Cancelled LCCN and update Instance with Suppress From Discovery'
