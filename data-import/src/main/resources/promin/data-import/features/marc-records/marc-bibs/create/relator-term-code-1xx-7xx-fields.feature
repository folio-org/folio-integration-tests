Feature: Verify revision to relator term/code handling for 1xx7xx fields
  ...
  @C365638
  Scenario: Verify mapping of contributors from MARC 1xx/7xx fields (Personal/Corporate/Meeting names with relator terms and codes)
    ...
    * def expectedSourceByOrder = [ '#(expectedSourceRecord1)', '#(expectedSourceRecord2)', '#(expectedSourceRecord3)' ]
    ...
    # ============================================================================
    * def selfFeature = 'classpath:promin/data-import/features/marc-records/marc-bibs/create/relator-term-code-1xx-7xx-fields.feature'
