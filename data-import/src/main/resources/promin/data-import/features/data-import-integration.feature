Feature: Data Import integration tests
  ...
  Background:
    ...
    * def createExportMappingProfile = read('classpath:promin/data-import/global/data-export-profiles.feature@createMappingProfile')
    * def createExportJobProfile = read('classpath:promin/data-import/global/data-export-profiles.feature@createJobProfile')
  ...
  Scenario: update holdings with custom static location match
    ...
    * def marcRecord = read('classpath:promin/data-import/samples/mrc-files/FAT-1124.mrc')
