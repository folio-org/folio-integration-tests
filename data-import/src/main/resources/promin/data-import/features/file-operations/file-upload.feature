Feature: File upload
  ...
  Scenario: Upload EDIFACT .edi file
    ...
    * def fileId = response.fileDefinitions[0].id
    ...
    And request read('classpath:promin/data-import/samples/samples_for_upload/FAT-139_1.edi')
    When method POST
    Then status 200
  ...
  Scenario: Upload EDIFACT .inv file
    ...
    * def fileId = response.fileDefinitions[0].id
    ...
    Given path 'data-import/uploadDefinitions', uploadDefinitionId, 'files', fileId
    And headers headersUserOctetStream
    And request read('classpath:promin/data-import/samples/samples_for_upload/FAT-139_2.inv')
    When method POST
    Then status 200
  ...
  Scenario: Upload MARC .mrc file
    ...
    * def fileId = response.fileDefinitions[0].id
    ...
    Given path 'data-import/uploadDefinitions', uploadDefinitionId, 'files', fileId
    And headers headersUserOctetStream
    And request read('classpath:promin/data-import/samples/samples_for_upload/FAT-139_3.mrc')
    When method POST
    Then status 200
  ...
  Scenario: Upload MARC .json file
    ...
    * def fileId = response.fileDefinitions[0].id
    ...
    Given path 'data-import/uploadDefinitions', uploadDefinitionId, 'files', fileId
    And headers headersUserOctetStream
    And request read('classpath:promin/data-import/samples/samples_for_upload/FAT-139_4.json')
    When method POST
    Then status 200
  ...
  Scenario: Upload MARC .xml file
    ...
    * def fileId = response.fileDefinitions[0].id
    ...
    Given path 'data-import/uploadDefinitions', uploadDefinitionId, 'files', fileId
    And headers headersUserOctetStream
    And request read('classpath:promin/data-import/samples/samples_for_upload/FAT-139_5.xml')
    When method POST
    Then status 200
