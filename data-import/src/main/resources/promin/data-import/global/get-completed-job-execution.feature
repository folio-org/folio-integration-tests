Feature: Get job execution by id
  ...
  Scenario: wait until job status will be 'completed'
    ...
    * if (jobStatus == 'ERROR') karate.call('classpath:promin/data-import/global/check-job-log-entries.feature', { jobExecutionId: __arg.jobExecutionId, headersUser: headersUser })
