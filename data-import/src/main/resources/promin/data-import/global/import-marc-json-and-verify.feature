Feature: Import MARC JSON and Verify
  ...
  Scenario: Import MARC JSON record and verify
    ...
    * if (jobExecution.status == 'ERROR') karate.call('classpath:promin/data-import/global/check-job-log-entries.feature', { jobExecutionId: jobExecution.id, headersUser: headersUser })
