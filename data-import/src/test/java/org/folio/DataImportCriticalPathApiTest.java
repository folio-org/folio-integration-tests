...
public class DataImportCriticalPathApiTest extends TestBaseEureka {
  ...
  void deleteAuthorityDefaultJobProfile() {
    feature(DELETE_AUTHORITY_PATH + "delete-authority-default-job-profile.feature")
      .run();
  }

  @Test
  void deleteAuthorityDefaultJobProfileLinked() {
    feature(DELETE_AUTHORITY_PATH + "delete-authority-default-profile-linked.feature")
      .run();
  }

  @Test
  void deleteAuthorityJobSummaryStatuses() {
    feature(DELETE_AUTHORITY_PATH + "delete-authority-job-summary-statuses.feature")
      .run();
  }

  @Test
  void deleteAuthorityMatchBy001() {
    feature(DELETE_AUTHORITY_PATH + "delete-authority-match-001.feature")
      .run();
  }
  ...
  void deleteAuthorityMatchBy010a() {
    feature(DELETE_AUTHORITY_PATH + "delete-authority-match-010a.feature")
      .run();
  }
  ...
  @Test
  void authorityComparisonPart() {
    feature(MATCH_AUTHORITY_PATH + "authority-comparison-part.feature")
      .run();
  }

  @Test
  void bibComparisonPart() {
    feature(MATCH_BIB_PATH + "bib-comparison-part.feature")
      .run();
  }
}
