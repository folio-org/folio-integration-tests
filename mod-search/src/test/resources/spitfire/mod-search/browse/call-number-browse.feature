Feature: Tests that browse by call-numbers
  ...
  Scenario: Can browse around by single letter
    ...
    Then match response.next == 'TK 45105.88815 A58 42004 FT MEADE SUFFIX 590000'
    ...
    [
      ...
      {
        "shelfKey": "TK 45105.88815 A58 42004 FT MEADE SUFFIX 590000",
  ...
  Scenario: Can browse forward from the smallest value
    ...
    Then match response.next == '3325.24'
    Then match karate.jsonPath(response, "$.items[*].['shelfKey', 'fullCallNumber', 'totalRecords']") ==
    """
    [
      ...
      { "shelfKey": "3325.24", "fullCallNumber": "325.24", "totalRecords": 1 }
    ]
    """
  ...
  Scenario: Can browse backward from the largest value
    ...
    [
      ...
      {
        "shelfKey":"TK 45105.88815 A58 42004 FT MEADE V1 COPY 12 SUFFIX 510101",
