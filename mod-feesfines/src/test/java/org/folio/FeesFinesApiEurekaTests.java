...
class FeesFinesApiEurekaTests extends TestBaseEureka {

    private static final String TEST_BASE_PATH = "classpath:vega/mod-feesfines/eureka-features/";

    public FeesFinesApiEurekaTests() {
