...
/**
 * mod-di-converter-storage scenarios that TestRail classifies as Extended.
 */
@FolioTest(team = "promin", module = "mod-di-converter-storage")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class ModDiConverterStorageExtendedApiTest extends TestBaseEureka {
  ...
  public ModDiConverterStorageExtendedApiTest() {
  ...
  @Test
  void deleteActionProfileRecordType() {
    feature(DELETE_AUTHORITY_PATH + "delete-authority-action-profile-record-type.feature")
      .run();
  }
}
